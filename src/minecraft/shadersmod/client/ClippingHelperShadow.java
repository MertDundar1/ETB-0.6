...
public class ClippingHelperShadow extends ClippingHelper
{
  ...
  public void init()
  {
    float[] matPrj = field_178625_b;
    float[] matMdv = field_178626_c;
    float[] matMP = clippingMatrix;
    ...
    float test0 = (float)dot3(frustum[0], vecSun);
    float test1 = (float)dot3(frustum[1], vecSun);
    float test2 = (float)dot3(frustum[2], vecSun);
    float test3 = (float)dot3(frustum[3], vecSun);
    float test4 = (float)dot3(frustum[4], vecSun);
    float test5 = (float)dot3(frustum[5], vecSun);

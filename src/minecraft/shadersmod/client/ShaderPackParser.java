...
public class ShaderPackParser
{
  ...
  public static ShaderOption[] parseShaderPackOptions(IShaderPack shaderPack, String[] programNames, List<Integer> listDimensions) { if (shaderPack == null)
    {
    ...
    Comparator comp1 = new Comparator()
    {
      ...
      public int compare(Object x0, Object x1) {
        return compare((ShaderOption)x0, (ShaderOption)x1);
      }
    };

...
public class Shaders
{
  ...
  static File shadersdir = new File(getMinecraftmcDataDir, "shaders");
  static File shaderpacksdir = new File(getMinecraftmcDataDir, shaderpacksdirname);
  static File configFile = new File(getMinecraftmcDataDir, optionsfilename);
  ...
  public static void loadShaderPack()
  {
    ...
    {
      net.minecraft.client.renderer.vertex.DefaultVertexFormats.updateVertexFormats();
  ...
  private static ShaderOption[] getShaderOptionsRest(Map<String, ShaderOption[]> mapScreens, ShaderOption[] ops)
  {
        ...
        name < so.length)
    {
      ...
      so = (ShaderOption[])mapScreens.get(sos);
  ...
  private static void saveOptionProperties(IShaderPack sp, Properties props) throws IOException
  {
    ...
    File propFile = new File(getMinecraftmcDataDir, path);
  ...
  {
    mcingameGUI.getChatGUI().printChatMessage(new ChatComponentText(str));
  }
  ...
  public static void init()
  {
    ...
    if (!isShaderPackInitialized)
    {
      ...
      {
        int maxDrawBuffers = currentWorldprovider.getDimensionId();
      ...
      for (int maxDrawBuffers = 0; maxDrawBuffers < 33; maxDrawBuffers++)
      {
        ...
        {
          int tmp391_390 = 0;programsRef[maxDrawBuffers] = tmp391_390;programsID[maxDrawBuffers] = tmp391_390;
        ...
        else
        {
          ...
          int tmp612_610 = intbuf;programsRef[maxDrawBuffers] = tmp612_610;programsID[maxDrawBuffers] = tmp612_610;
      ...
      for (int var12 = 0; var12 < 33; var12++)
      {
        ...
        {
          String n = programsDrawBufSettings[var12];
          ...
          if (n != null)
          {
            ...
            for (int i1 = 0; i1 < numDB; i1++)
            {
              ...
              if (n.length() > i1)
              {
                int ca = n.charAt(i1) - '0';
                
                if (var12 != 30)
                {
                  if ((ca >= 0) && (ca <= 7))
                  {
                    programsToggleColorTextures[var12][ca] = 1;
                    drawBuffer = ca + 36064;
      ...
      for (var12 = 0; var12 < 33; var12++)
      {
        ...
        for (int var13 = var12; (programsID[var13] == 0) && (programBackups[var13] != var13); var13 = programBackups[var13]) {}
  ...
  public static void resetDisplayListModelRenderer(ModelRenderer mrr)
  {
    ...
    if (childModels != null)
    {
      ...
      for (int n = childModels.size(); i < n; i++)
      {
        resetDisplayListModelRenderer((ModelRenderer)childModels.get(i));
      }
    }
  }
  ...
  private static int createVertShader(String filename)
  {
    ...
    if (reader != null)
    {
      try
      {
        ...
        {
          String line = applyOptions(line, activeOptions);
        ...
        while ((line = reader.readLine()) != null)
        {
          ...
          if (!line.matches("#version .*"))
          {
            ...
            else if (line.matches("/\\* SHADOWRES:[0-9]+ \\*/.*"))
            {
              ...
              shadowMapWidth = Shaders.shadowMapHeight = Math.round(spShadowMapWidth * configShadowResMul);
            }
            ...
            {
              Matcher e1 = gbufferFormatPattern.matcher(line);
              e1.matches();
            ...
            else if (line.matches("[ \t]*const[ \t]*bool[ \t]*\\w+MipmapEnabled[ \t]*=[ \t]*true[ \t]*;.*"))
            {
              ...
              {
                Matcher e1 = gbufferMipmapEnabledPattern.matcher(line);
                e1.matches();
                String name = e1.group(1);
  ...
  public static void useProgram(int program)
  {
    ...
    if (activeProgram != program)
    {
      ...
      else
      {
        ...
        ItemStack stack = mcthePlayer.getCurrentEquippedItem();
        ...
        setProgramUniform1f("far", mcgameSettings.renderDistanceChunks * 16);
        ...
        setProgramUniform1i("hideGUI", mcgameSettings.hideGUI ? 1 : 0);
  ...
  {
    return (!name.equals("colortex0")) && (!name.equals("gcolor")) ? 1 : (!name.equals("colortex1")) && (!name.equals("gdepth")) ? 2 : (!name.equals("colortex2")) && (!name.equals("gnormal")) ? 3 : (!name.equals("colortex3")) && (!name.equals("composite")) ? 4 : (!name.equals("colortex4")) && (!name.equals("gaux1")) ? 5 : (!name.equals("colortex5")) && (!name.equals("gaux2")) ? 6 : (!name.equals("colortex6")) && (!name.equals("gaux3")) ? 7 : (!name.equals("colortex7")) && (!name.equals("gaux4")) ? -1 : 0;
  }
  ...
  {
    mapBlockToEntityData = new java.util.IdentityHashMap(300);
  ...
  {
    renderDisplayWidth = mcdisplayWidth;
    renderDisplayHeight = mcdisplayHeight;
  ...
  private static void setupFrameBuffer()
  {
    ...
    for (int status = 0; status < usedDepthBuffers; status++)
    {
  ...
  private static void setupShadowFrameBuffer()
  {
    if (usedShadowDepthBuffers != 0)
    {
      ...
      for (int status = 0; status < usedShadowDepthBuffers; status++)
      {
        GlStateManager.func_179144_i(sfbDepthTextures.get(status));
        GL11.glTexParameterf(3553, 10242, 10496.0F);
        GL11.glTexParameterf(3553, 10243, 10496.0F);
        int filter = shadowFilterNearest[status] != 0 ? 9728 : 9729;
        GL11.glTexParameteri(3553, 10241, filter);
        GL11.glTexParameteri(3553, 10240, filter);
        
        if (shadowHardwareFilteringEnabled[status] != 0)
        {
      ...
      for (status = 0; status < usedShadowColorBuffers; status++)
      {
        ...
        GL11.glTexParameterf(3553, 10242, 10496.0F);
        GL11.glTexParameterf(3553, 10243, 10496.0F);
        int filter = shadowColorFilterNearest[status] != 0 ? 9728 : 9729;
        GL11.glTexParameteri(3553, 10241, filter);
        GL11.glTexParameteri(3553, 10240, filter);
  ...
  public static void beginRender(Minecraft minecraft, float partialTicks, long finishTimeNano)
  {
    ...
    checkWorldChanged(mctheWorld);
    mc = minecraft;
    mcmcProfiler.startSection("init");
    entityRenderer = mcentityRenderer;
    ...
    if ((mcdisplayWidth != renderDisplayWidth) || (mcdisplayHeight != renderDisplayHeight))
    {
      resize();
    }
    ...
    worldTime = mctheWorld.getWorldTime();
    ...
    moonPhase = mctheWorld.getMoonPhase();
    ...
    rainStrength = theWorld.getRainStrength(partialTicks);
    float renderViewEntity = (float)diffSystemTime * 0.01F;
    float i = (float)Math.exp(Math.log(0.5D) * renderViewEntity / (wetness < rainStrength ? drynessHalfLife : wetnessHalfLife));
    ...
    eyePosY = (float)posY * partialTicks + (float)lastTickPosY * (1.0F - partialTicks);
    ...
    isEyeInWater = (mcgameSettings.thirdPersonView == 0) && (!isSleeping) && (mcthePlayer.isInsideOfMaterial(net.minecraft.block.material.Material.water)) ? 1 : 0;
    Vec3 var9 = mctheWorld.getSkyColor(mc.func_175606_aa(), partialTicks);
    skyColorR = (float)xCoord;
    skyColorG = (float)yCoord;
    skyColorB = (float)zCoord;
    ...
    for (int var10 = 0; var10 < usedColorBuffers; var10++)
    {
    ...
    if (noiseTextureEnabled)
    {
      GlStateManager.setActiveTexture(33984 + noiseTexturetextureUnit);
  ...
  private static void checkWorldChanged(World world)
  {
    if (currentWorld != world)
    {
      ...
      {
        int dimIdOld = provider.getDimensionId();
        int dimIdNew = provider.getDimensionId();
  ...
  public static void setCameraShadow(float partialTicks)
  {
    ...
    celestialAngle = mctheWorld.getCelestialAngle(partialTicks);
    ...
    setProgramUniformMatrix4ARB("shadowModelView", false, shadowModelView);
    setProgramUniformMatrix4ARB("shadowModelViewInverse", false, shadowModelViewInverse);
    mcgameSettings.thirdPersonView = 1;
    checkGLError("setCamera");
  }
    ...
    if (hasGlGenMipmap)
    {
      for (int i = 0; i < usedColorBuffers; i++)
      {
        if ((activeCompositeMipmapSetting & 1 << i) != 0)
        {
          ...
          org.lwjgl.opengl.GL30.glGenerateMipmap(3553);
        }
      }
  ...
  public static void renderCompositeFinal()
  {
    if (!isShadowPass)
    {
      ...
      for (int enableAltBuffers = 0; enableAltBuffers < usedColorBuffers; enableAltBuffers++)
      {
      ...
      for (int maskR = 0; maskR < usedColorBuffers; maskR++)
      {
      ...
      for (maskR = 0; maskR < 8; maskR++)
      {
        if (programsID[(21 + maskR)] != 0)
        {
          ...
          for (int i = 0; i < usedColorBuffers; i++)
          {
            if (programsToggleColorTextures[(21 + maskR)][i] != 0)
            {
      ...
      OpenGlHelper.func_153188_a(OpenGlHelper.field_153198_e, OpenGlHelper.field_153200_g, 3553, mcgetFramebufferframebufferTexture, 0);
      GL11.glViewport(0, 0, mcdisplayWidth, mcdisplayHeight);
  ...
  public static void drawHorizon()
  {
    ...
    float farDistance = mcgameSettings.renderDistanceChunks * 16;
  ...
  public static boolean shouldRenderClouds(GameSettings gs)
  {
    ...
    return isShadowPass ? configCloudShadow : clouds;
  }
  ...
  public static void setEntityId(Entity entity)
  {
    ...
    {
      int id = net.minecraft.entity.EntityList.getEntityID(entity);
  ...
  private static final String[] formatNames = { "R8", "RG8", "RGB8", "RGBA8", "R8_SNORM", "RG8_SNORM", "RGB8_SNORM", "RGBA8_SNORM", "R16", "RG16", "RGB16", "RGBA16", "R16_SNORM", "RG16_SNORM", "RGB16_SNORM", "RGBA16_SNORM", "R32F", "RG32F", "RGB32F", "RGBA32F", "R32I", "RG32I", "RGB32I", "RGBA32I", "R32UI", "RG32UI", "RGB32UI", "RGBA32UI" };
  private static final int[] formatIds = { 33321, 33323, 32849, 32856, 36756, 36757, 36758, 36759, 33322, 33324, 32852, 32859, 36760, 36761, 36762, 36763, 33326, 33328, 34837, 34836, 33333, 33339, 36227, 36226, 33334, 33340, 36209, 36208 };

...
public enum ErrorCode
{
  ...
  TTV_EC_WARNING_START(64536), 
  TTV_WRN_MUTEX_LOCKED(64537), 
  TTV_WRN_FAILED_TO_INIT_MIC_CAPTURE(64538), 
  TTV_WRN_NOTENOUGHDATA(64539), 
  TTV_WRN_NOMOREDATA(64540), 
  TTV_WRN_FRAMES_QUEUEING(64541), 
  TTV_WRN_MUTEX_NOT_AQUIRED(64542), 
  TTV_WRN_PREV_GAME_NAME_MATCH_REQUEST_DROPPED(64543), 
  TTV_WRN_DEPRECATED(64544), 
  TTV_WRN_CHAT_MESSAGE_SPAM_DISCARDED(64545), 
  TTV_WRN_WAIT_TIMEOUT(64546), 
  TTV_WRN_STREAMINFO_PENDING(64547);
  
  static { s_Map = new java.util.HashMap();
    


    java.util.EnumSet localEnumSet = java.util.EnumSet.allOf(ErrorCode.class);
    
    for (ErrorCode localErrorCode : localEnumSet)
    {
      s_Map.put(Integer.valueOf(localErrorCode.getValue()), localErrorCode);
    }
  }
  
  public static ErrorCode lookupValue(int paramInt)
  {
    ErrorCode localErrorCode = (ErrorCode)s_Map.get(Integer.valueOf(paramInt));
  ...
  public static String getString(ErrorCode paramErrorCode)
  {
    ...
    return localCore.errorToString(paramErrorCode);
  }
}

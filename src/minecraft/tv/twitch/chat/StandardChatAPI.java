...
public class StandardChatAPI extends ChatAPI { public StandardChatAPI() {}
  ...
  public ErrorCode initialize(java.util.HashSet<ChatTokenizationOption> paramHashSet, IChatAPIListener paramIChatAPIListener) { int i = ChatTokenizationOption.getNativeValue(paramHashSet);

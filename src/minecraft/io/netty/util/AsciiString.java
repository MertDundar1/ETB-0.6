  ...
  implements CharSequence, Comparable<CharSequence>
{
  ...
  public boolean contentEqualsIgnoreCase(CharSequence string)
  {
    ...
    if (string.getClass() == AsciiString.class) {
      ...
      int i = arrayOffset(); for (int j = rhs.arrayOffset(); i < length(); j++) {
    ...
    int i = arrayOffset(); for (int j = 0; i < length(); j++) {
  ...
  public int indexOf(CharSequence subString, int start)
  {
    ...
    try {
      for (;;) {
        ...
        int o1 = i;int o2 = 0;
        do { o2++; } while ((o2 < subCount) && (b2c(value[(++o1 + arrayOffset())]) == subString.charAt(o2)));
  ...
  public AsciiString replace(char oldChar, char newChar)
  {
    ...
    int i = 0; for (int j = arrayOffset(); i < buffer.length; j++) {
      byte b = value[j];
      if (b == oldCharByte) {
        b = newCharByte;
      }
  ...
  public static boolean contentEqualsIgnoreCase(CharSequence a, CharSequence b)
  {
    ...
    int i = 0; for (int j = 0; i < a.length(); j++) {

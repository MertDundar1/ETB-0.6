  ...
  implements Future<V>, Serializable
{
  ...
  private int doJoin()
  {
    ...
    return ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread) ? pool.awaitJoin(w, this) : ((w = workQueue).tryUnpush(this)) && ((s = doExec()) < 0) ? s : (s = status) < 0 ? s : externalAwaitDone();
  }
  ...
  private int doInvoke()
  {
    ...
    return ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread) ? pool.awaitJoin(workQueue, this) : (s = doExec()) < 0 ? s : externalAwaitDone();
  }
  ...
  final int recordExceptionalCompletion(Throwable ex)
  {
    ...
    if ((s = status) >= 0) {
      ...
      try {
        ...
        int i = h & t.length - 1;
        for (ExceptionNode e = t[i];; e = next) {
          if (e == null) {
  ...
  {
    t2.fork();
    int s1; if ((s1 = t1.doInvoke() & 0xF0000000) != -268435456)
      t1.reportException(s1);
    int s2; if ((s2 = t2.doJoin() & 0xF0000000) != -268435456) {
    ...
    throws InterruptedException, ExecutionException
  {
    ...
    if ((s &= 0xF0000000) == -1073741824)
      throw new CancellationException();
    Throwable ex; if ((s == Integer.MIN_VALUE) && ((ex = getThrowableException()) != null))
    ...
    throws InterruptedException, ExecutionException, TimeoutException
  {
      ...
      try {
        while ((s = status) >= 0) {
          if ((w != null) && (qlock < 0)) {
            ...
            if (((s = status) >= 0) && (!interrupted)) if ((ns = deadline - System.nanoTime()) <= 0L) {
                break;
              }
          }
        }
    ...
    if ((s &= 0xF0000000) != -268435456)
    {
      ...
      Throwable ex; if ((ex = getThrowableException()) != null)
        throw new ExecutionException(ex);
    }
    return getRawResult();
  }
  ...
  {
    Thread t = Thread.currentThread();
    return (t instanceof ForkJoinWorkerThread) ? pool : null;
  }
  ...
  public boolean tryUnfork()
  {
    ...
    return ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread) ? workQueue.tryUnpush(this) : ForkJoinPool.common.tryExternalUnpush(this);
  }
  ...
  protected static ForkJoinTask<?> pollNextLocalTask()
  {
    ...
    return ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread) ? workQueue.nextLocalTask() : null;
  }
  ...
  protected static ForkJoinTask<?> pollTask()
  {
    ...
    return ((t = Thread.currentThread()) instanceof ForkJoinWorkerThread) ? pool.nextTaskFor(workQueue) : null;
  }
  ...
  public final short setForkJoinTaskTag(short tag)
  {
    ...
    while (!U.compareAndSwapInt(this, STATUS, s = status, s & 0xFFFF0000 | tag & 0xFFFF)) {}
  ...
  static final class RunnableExecuteAction extends ForkJoinTask<Void>
  {
    ...
    void internalPropagateException(Throwable ex) { rethrow(ex); }
  }
  ...
  static { exceptionTable = new ExceptionNode[32];
    try {
      U = getUnsafe();

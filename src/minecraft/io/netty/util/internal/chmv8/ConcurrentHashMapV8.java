  ...
  implements ConcurrentMap<K, V>, Serializable
{
  ...
  static class Node<K, V> implements Map.Entry<K, V> { Node(int hash, K key, V val, Node<K, V> next) { this.hash = hash;
      this.key = key;
      this.val = val;
      this.next = next;
    }
    ...
    public final boolean equals(Object o) { Map.Entry<?, ?> e;
      Object k;
      Object v;
      Object u; return ((o instanceof Map.Entry)) && ((k = (e = (Map.Entry)o).getKey()) != null) && ((v = e.getValue()) != null) && ((k == key) || (k.equals(key))) && ((v == (u = val)) || (v.equals(u)));
    }
    ...
    Node<K, V> find(int h, Object k)
    {
      ...
      if (k != null) {
        do {
          K ek;
          if ((hash == h) && (((ek = key) == k) || ((ek != null) && (k.equals(ek)))))
          {
            return e; }
        } while ((e = next) != null);
      }
  ...
  static Class<?> comparableClassFor(Object x)
  {
    if ((x instanceof Comparable)) {
      ...
      if ((c = x.getClass()) == String.class)
        return c;
      Type[] ts; if ((ts = c.getGenericInterfaces()) != null) {
        for (int i = 0; i < ts.length; i++) { Type t;
          ParameterizedType p; Type[] as; if ((((t = ts[i]) instanceof ParameterizedType)) && ((p = (ParameterizedType)t).getRawType() == Comparable.class) && ((as = p.getActualTypeArguments()) != null) && (as.length == 1) && (as[0] == c))
          {
  ...
  public V get(Object key)
  {
    ...
    Node<K, V>[] tab; int n; Node<K, V> e; if (((tab = table) != null) && ((n = tab.length) > 0) && ((e = tabAt(tab, n - 1 & h)) != null)) {
      int eh;
      if ((eh = hash) == h) { K ek;
        if (((ek = key) == key) || ((ek != null) && (key.equals(ek)))) {
          return val;
        }
      } else if (eh < 0) { Node<K, V> p;
        return (p = e.find(h, key)) != null ? val : null; }
      while ((e = next) != null) { K ek;
        if ((hash == h) && (((ek = key) == key) || ((ek != null) && (key.equals(ek)))))
        {
          return val; }
      }
    }
  ...
  public boolean containsValue(Object value)
  {
    ...
    if ((t = table) != null) {
      ...
      Node<K, V> p; while ((p = it.advance()) != null) {
        V v;
        if (((v = val) == value) || ((v != null) && (value.equals(v))))
          return true;
      }
    }
    return false;
  ...
  final V putVal(K key, V value, boolean onlyIfAbsent)
  {
    ...
    for (;;) { int n;
      if ((tab == null) || ((n = tab.length) == 0)) {
        tab = initTable(); } else { int n;
        int i; Node<K, V> f; if ((f = tabAt(tab, i = n - 1 & hash)) == null) {
              ...
              if (tabAt(tab, i) == f) {
                if (fh >= 0) {
                  ...
                  for (Node<K, V> e = f;; binCount++) {
                    K ek;
                    if ((hash == hash) && (((ek = key) == key) || ((ek != null) && (key.equals(ek)))))
                    {
                    ...
                    Node<K, V> pred = e;
                    if ((e = next) == null) {
                      next = new Node(hash, key, value, null);
                ...
                {
                  binCount = 2;
                  Node<K, V> p; if ((p = ((TreeBin)f).putTreeVal(hash, key, value)) != null)
                  {
                    oldVal = val;
                    if (!onlyIfAbsent)
                      val = value;
  ...
  final V replaceNode(Object key, V value, Object cv)
  {
    ...
    Node<K, V>[] tab = table;
    int n;
    int i; Node<K, V> f; while ((tab != null) && ((n = tab.length) != 0) && ((f = tabAt(tab, i = n - 1 & hash)) != null))
    {
      int fh;
      if ((fh = hash) == -1) {
        tab = helpTransfer(tab, f);
        ...
        synchronized (f) {
          if (tabAt(tab, i) == f) {
            if (fh >= 0) {
              ...
              TreeNode<K, V> r;
              TreeNode<K, V> p; if (((r = root) != null) && ((p = r.findTreeNode(hash, key, null)) != null))
              {
                V pv = val;
                if ((cv == null) || (cv == pv) || ((pv != null) && (cv.equals(pv))))
                {
                  ...
                  if (value != null) {
                    ...
                    setTabAt(tab, i, untreeify(first));
                }
              }
            }
          }
    ...
    while ((tab != null) && (i < tab.length))
    {
      ...
      if (f == null) {
        ...
        if ((fh = hash) == -1) {
          ...
          synchronized (f) {
            if (tabAt(tab, i) == f) {
              Node<K, V> p = (f instanceof TreeBin) ? first : fh >= 0 ? f : null;
  ...
  public boolean equals(Object o)
  {
    if (o != this) {
      ...
      for (Map.Entry<?, ?> e : m.entrySet()) { Object mk;
        Object mv;
        Object v; if (((mk = e.getKey()) == null) || ((mv = e.getValue()) == null) || ((v = get(mk)) == null) || ((mv != v) && (!mv.equals(v))))
        {
    ...
    throws IOException, ClassNotFoundException
  {
    ...
    if (size == 0L) {
      ...
      {
        Node<K, V> next = next;
        int h = hash;int j = h & mask;
        Node<K, V> first; boolean insertAtFront; boolean insertAtFront; if ((first = tabAt(tab, j)) == null) {
          insertAtFront = true;
        } else {
          K k = key;
          boolean insertAtFront; if (hash < 0) {
            TreeBin<K, V> t = (TreeBin)first;
            if (t.putTreeVal(h, k, val) == null)
              added += 1L;
            insertAtFront = false;
          }
          else {
            ...
            for (Node<K, V> q = first; q != null; q = next) { K qk;
              if ((hash == h) && (((qk = key) == k) || ((qk != null) && (k.equals(qk)))))
              {
            ...
            if ((insertAtFront) && (binCount >= 8)) {
              ...
              for (q = p; q != null; q = next) {
                TreeNode<K, V> t = new TreeNode(hash, key, val, null, null);
  ...
  public void replaceAll(BiFun<? super K, ? super V, ? extends V> function) {
    ...
    if ((t = table) != null) {
      ...
      Node<K, V> p; while ((p = it.advance()) != null) {
        V oldValue = val;
        K key = key;
        for (;;) { V newValue = function.apply(key, oldValue);
          if (newValue == null)
            throw new NullPointerException();
  ...
  public V computeIfAbsent(K key, Fun<? super K, ? extends V> mappingFunction)
  {
    ...
    for (;;) { int n;
      if ((tab == null) || ((n = tab.length) == 0)) {
        tab = initTable(); } else { int n;
        int i; Node<K, V> f; if ((f = tabAt(tab, i = n - 1 & h)) == null) {
              ...
              if (tabAt(tab, i) == f) {
                if (fh >= 0) {
                  ...
                  for (Node<K, V> e = f;; binCount++) {
                    ...
                    Node<K, V> pred = e;
                    if ((e = next) == null) {
                      if ((val = mappingFunction.apply(key)) == null) break;
                      added = true;
                      next = new Node(h, key, val, null); break;
                    }
                  ...
                  TreeBin<K, V> t = (TreeBin)f;
                  Object r;
                  Object p; if (((r = root) != null) && ((p = ((TreeNode)r).findTreeNode(h, key, null)) != null))
                  {
                    val = val;
  ...
  public V computeIfPresent(K key, BiFun<? super K, ? super V, ? extends V> remappingFunction)
  {
    ...
    for (;;) { int n;
      if ((tab == null) || ((n = tab.length) == 0)) {
        tab = initTable(); } else { int n;
        int i; Node<K, V> f; if ((f = tabAt(tab, i = n - 1 & h)) == null) break;
        int fh;
        if ((fh = hash) == -1) {
          tab = helpTransfer(tab, f);
        } else {
          synchronized (f) {
            if (tabAt(tab, i) == f) {
              if (fh >= 0) {
                binCount = 1;
                Node<K, V> e = f; for (Node<K, V> pred = null;; binCount++) {
                  K ek;
                  if ((hash == h) && (((ek = key) == key) || ((ek != null) && (key.equals(ek)))))
                  {

                    val = remappingFunction.apply(key, val);
                    if (val != null) {
                      val = val;
                    } else {
                      delta = -1;
                ...
                TreeBin<K, V> t = (TreeBin)f;
                TreeNode<K, V> r;
                TreeNode<K, V> p; if (((r = root) != null) && ((p = r.findTreeNode(h, key, null)) != null))
                {
                  val = remappingFunction.apply(key, val);
                  if (val != null) {
                    val = val;
            ...
            synchronized (f) {
              if (tabAt(tab, i) == f) {
                if (fh >= 0) {
                  ...
                  TreeBin<K, V> t = (TreeBin)f;
                  TreeNode<K, V> r;
                  Object p; TreeNode<K, V> p; if ((r = root) != null) {
                    p = r.findTreeNode(h, key, null);
                  } else
                    p = null;
                  Object pv = p == null ? null : val;
                ...
                if (fh >= 0) {
                  ...
                  Node<K, V> e = f; for (Node<K, V> pred = null;; binCount++) {
                    ...
                    if ((hash == h) && (((ek = key) == key) || ((ek != null) && (key.equals(ek)))))
                    {
                      ...
                      val = remappingFunction.apply(val, value);
                      if (val != null) {
                        val = val; break;
                      }
                      delta = -1;
                  ...
                  val = p == null ? value : remappingFunction.apply(val, value);
    ...
    extends ConcurrentHashMapV8.Node<K, V>
  {
    ...
    {
      ConcurrentHashMapV8.Node<K, V>[] tab = nextTable;
      int n;
      ConcurrentHashMapV8.Node<K, V> e; if ((k == null) || (tab == null) || ((n = tab.length) == 0) || ((e = ConcurrentHashMapV8.tabAt(tab, n - 1 & h)) == null))
      {
        return null; }
      for (;;) { int n;
        ConcurrentHashMapV8.Node<K, V> e;
        int eh; K ek; if (((eh = hash) == h) && (((ek = key) == k) || ((ek != null) && (k.equals(ek)))))
        {
          return e; }
        if (eh < 0) {
  ...
  private final Node<K, V>[] initTable()
  {
    ...
    while (((tab = table) == null) || (tab.length == 0)) { int sc;
      if ((sc = sizeCtl) < 0) {
        Thread.yield();
  ...
  private final void addCount(long x, int check)
  {
    ...
    if (((as = counterCells) != null) || (!U.compareAndSwapLong(this, BASECOUNT, b = baseCount, s = b + x)))
    {
      ...
      IntegerHolder hc; int m; CounterCell a; long v; if (((hc = threadLocals.counterHashCode()) == null) || (as == null) || ((m = as.length - 1) < 0) || ((a = as[(m & value)]) == null) || (!(uncontended = U.compareAndSwapLong(a, CELLVALUE, v = value, v + x))))
      {
      ...
      int m;
      long v;
      CounterCell a; if (check <= 1)
        return;
      s = sumCount();
    }
    if (check >= 0) { int sc;
      Node<K, V>[] tab;
      while ((s >= (sc = sizeCtl)) && ((tab = table) != null) && (tab.length < 1073741824))
      {
        if (sc < 0) { Node<K, V>[] nt;
  ...
  final Node<K, V>[] helpTransfer(Node<K, V>[] tab, Node<K, V> f)
  {
    ...
    if (((f instanceof ForwardingNode)) && ((nextTab = nextTable) != null)) {
      int sc;
  ...
  private final void tryPresize(int size)
  {
    ...
    while ((sc = sizeCtl) >= 0) {
      Node<K, V>[] tab = table;
      int n; int n; if ((tab == null) || ((n = tab.length) == 0)) {
        n = sc > c ? sc : c;
        ...
        if ((c <= sc) || (n >= 1073741824))
          break;
        if ((tab == table) && (U.compareAndSwapInt(this, SIZECTL, sc, -2)))
        {
          transfer(tab, null);
        }
      }
  ...
  {
    int n = tab.length;
    int stride; if ((stride = NCPU > 1 ? (n >>> 3) / NCPU : n) < 16)
      stride = 16;
    ForwardingNode<K, V> rev; int k; if (nextTab == null)
    {
      try {
    ...
    for (;;) {
      if (advance) {
        i--; if ((i >= bound) || (finishing)) {
          advance = false; } else { int nextIndex;
          if ((nextIndex = transferIndex) <= transferOrigin) {
            i = -1;
            advance = false;
          } else { int nextBound;
        ...
        int sc;
        while (!U.compareAndSwapInt(this, SIZECTL, sc = sizeCtl, ++sc)) {}
        if (sc != -1)
          return;
        finishing = advance = 1;
        i = n;
            ...
            synchronized (f) {
              if (tabAt(tab, i) == f)
              {
                if (fh >= 0) {
                  int runBit = fh & n;
                  Node<K, V> lastRun = f;
                  for (Node<K, V> p = next; p != null; p = next) {
                    int b = hash & n;
                    if (b != runBit) {
                      runBit = b;
                      lastRun = p; } }
                  ...
                  for (Node<K, V> p = f; p != lastRun; p = next) {
                    int ph = hash;K pk = key;V pv = val;
                    if ((ph & n) == 0) {
                  ...
                  for (Node<K, V> e = first; e != null; e = next) {
                    int h = hash;
                    TreeNode<K, V> p = new TreeNode(h, key, val, null, null);
  ...
  {
    if (tab != null) { int n;
      if ((n = tab.length) < 64) { int sc;
        if ((tab == table) && ((sc = sizeCtl) >= 0) && (U.compareAndSwapInt(this, SIZECTL, sc, -2)))
        {
          transfer(tab, null); }
      } else { Node<K, V> b;
        if (((b = tabAt(tab, index)) != null) && (hash >= 0)) {
          synchronized (b) {
            if (tabAt(tab, index) == b) {
              TreeNode<K, V> hd = null;TreeNode<K, V> tl = null;
              for (Node<K, V> e = b; e != null; e = next) {
                TreeNode<K, V> p = new TreeNode(hash, key, val, null, null);
  ...
  static <K, V> Node<K, V> untreeify(Node<K, V> b)
  {
    ...
    for (Node<K, V> q = b; q != null; q = next) {
      Node<K, V> p = new Node(hash, key, val, null);
      if (tl == null) {
        hd = p;
      } else
        next = p;
    ...
    extends ConcurrentHashMapV8.Node<K, V>
  {
    ...
    final TreeNode<K, V> findTreeNode(int h, Object k, Class<?> kc)
    {
      if (k != null) {
        ...
        do
        {
          TreeNode<K, V> pl = left;TreeNode<K, V> pr = right;
          int ph; if ((ph = hash) > h) {
            p = pl;
          } else if (ph < h) {
            p = pr; } else { K pk;
            if (((pk = key) == k) || ((pk != null) && (k.equals(pk))))
              return p;
    ...
    extends ConcurrentHashMapV8.Node<K, V>
  {
    ...
    TreeBin(ConcurrentHashMapV8.TreeNode<K, V> b)
    {
      ...
      ConcurrentHashMapV8.TreeNode<K, V> next; for (ConcurrentHashMapV8.TreeNode<K, V> x = b; x != null; x = next) {
        next = (ConcurrentHashMapV8.TreeNode)next;
        left = (x.right = null);
        if (r == null) {
          parent = null;
          red = false;
          ...
          for (;;) { int ph;
            int dir; int dir; if ((ph = hash) > hash) {
              dir = -1; } else { int dir;
              if (ph < hash) {
                dir = 1; } else { int dir;
                if ((kc != null) || ((kc = ConcurrentHashMapV8.comparableClassFor(key)) != null))
                {
                  dir = ConcurrentHashMapV8.compareComparables(kc, key, key);
                } else
                  dir = 0; } }
            ConcurrentHashMapV8.TreeNode<K, V> xp = p;
            if ((p = dir <= 0 ? left : right) == null) {
              parent = xp;
              if (dir <= 0) {
                left = x;
              } else
    ...
    {
      if (k != null) {
        for (ConcurrentHashMapV8.Node<K, V> e = first; e != null; e = next) {
          int s;
          if (((s = lockState) & 0x3) != 0) { K ek;
            if ((hash == h) && (((ek = key) == k) || ((ek != null) && (k.equals(ek)))))
            {
              return e;
            }
            ...
            try {
              ...
              Thread w;
              int ls;
              while (!U.compareAndSwapInt(this, LOCKSTATE, ls = lockState, ls - 4)) {}
              
              Thread w;
              if ((ls == 6) && ((w = waiter) != null))
    ...
    {
      Class<?> kc = null;
      ConcurrentHashMapV8.TreeNode<K, V> p = root;
      for (;;) {
        if (p == null) {
          first = (this.root = new ConcurrentHashMapV8.TreeNode(h, k, v, null, null));
          break; }
        int ph;
        int dir; if ((ph = hash) > h) {
          dir = -1; } else { int dir;
          if (ph < h) {
            dir = 1; } else { K pk;
            if (((pk = key) == k) || ((pk != null) && (k.equals(pk))))
              return p;
            int dir; if (((kc == null) && ((kc = ConcurrentHashMapV8.comparableClassFor(k)) == null)) || ((dir = ConcurrentHashMapV8.compareComparables(kc, k, pk)) == 0))
            {
              int dir;
              if (left == null) {
                dir = 1; } else { ConcurrentHashMapV8.TreeNode<K, V> pr;
                ConcurrentHashMapV8.TreeNode<K, V> q; int dir; if (((pr = right) == null) || ((q = pr.findTreeNode(h, k, kc)) == null))
                {
                  dir = -1;
        ...
        ConcurrentHashMapV8.TreeNode<K, V> xp = p;
        if ((p = dir < 0 ? left : right) == null) {
          ConcurrentHashMapV8.TreeNode<K, V> f = first;
          ConcurrentHashMapV8.TreeNode<K, V> x; first = (x = new ConcurrentHashMapV8.TreeNode(h, k, v, f, xp));
          if (f != null)
            prev = x;
          if (dir < 0) {
            left = x;
    ...
    {
      ConcurrentHashMapV8.TreeNode<K, V> next = (ConcurrentHashMapV8.TreeNode)next;
      ConcurrentHashMapV8.TreeNode<K, V> pred = prev;
      ...
      if (first == null) {
        ...
        return true; }
      ConcurrentHashMapV8.TreeNode<K, V> r;
      ConcurrentHashMapV8.TreeNode<K, V> rl; if (((r = root) == null) || (right == null) || ((rl = left) == null) || (left == null))
      {
        return true; }
      ConcurrentHashMapV8.TreeNode<K, V> rl; lockRoot();
      try
      {
        ConcurrentHashMapV8.TreeNode<K, V> pl = left;
        ConcurrentHashMapV8.TreeNode<K, V> pr = right;
        ConcurrentHashMapV8.TreeNode<K, V> replacement; ConcurrentHashMapV8.TreeNode<K, V> replacement; if ((pl != null) && (pr != null)) {
          ConcurrentHashMapV8.TreeNode<K, V> s = pr;
          ConcurrentHashMapV8.TreeNode<K, V> sl; while ((sl = left) != null)
            s = sl;
          boolean c = red;red = red;red = c;
          ConcurrentHashMapV8.TreeNode<K, V> sr = right;
          ConcurrentHashMapV8.TreeNode<K, V> pp = parent;
          if (s == pr) {
            parent = s;
            right = p;
          }
          else {
            ConcurrentHashMapV8.TreeNode<K, V> sp = parent;
            if ((p.parent = sp) != null) {
              if (s == left) {
                left = p;
              } else
          ...
          if ((s.parent = pp) == null) {
            ...
            right = s;
          ConcurrentHashMapV8.TreeNode<K, V> replacement; if (sr != null) {
            replacement = sr;
          } else
            replacement = p;
        } else { ConcurrentHashMapV8.TreeNode<K, V> replacement;
          if (pl != null) {
            replacement = pl; } else { ConcurrentHashMapV8.TreeNode<K, V> replacement;
            if (pr != null) {
              replacement = pr;
            } else
              replacement = p; } }
        if (replacement != p) {
          ConcurrentHashMapV8.TreeNode<K, V> pp = replacement.parent = parent;
          if (pp == null) {
            r = replacement;
          } else if (p == left) {
            left = replacement;
            ...
            right = replacement;
          left = (p.right = p.parent = null);
        }
        
        root = (red ? r : balanceDeletion(r, replacement));
    ...
    static <K, V> ConcurrentHashMapV8.TreeNode<K, V> rotateLeft(ConcurrentHashMapV8.TreeNode<K, V> root, ConcurrentHashMapV8.TreeNode<K, V> p)
    {
      ...
      if ((p != null) && ((r = right) != null)) { ConcurrentHashMapV8.TreeNode<K, V> rl;
        if ((rl = p.right = left) != null)
          parent = p;
        ConcurrentHashMapV8.TreeNode<K, V> pp; if ((pp = r.parent = parent) == null) {
          red = false;
        } else if (left == p) {
          left = r;
        } else
    ...
    static <K, V> ConcurrentHashMapV8.TreeNode<K, V> rotateRight(ConcurrentHashMapV8.TreeNode<K, V> root, ConcurrentHashMapV8.TreeNode<K, V> p)
    {
      ...
      if ((p != null) && ((l = left) != null)) { ConcurrentHashMapV8.TreeNode<K, V> lr;
        if ((lr = p.left = right) != null)
          parent = p;
        ConcurrentHashMapV8.TreeNode<K, V> pp; if ((pp = l.parent = parent) == null) {
          red = false;
        } else if (right == p) {
          right = l;
        } else
    ...
    static <K, V> ConcurrentHashMapV8.TreeNode<K, V> balanceInsertion(ConcurrentHashMapV8.TreeNode<K, V> root, ConcurrentHashMapV8.TreeNode<K, V> x)
    {
      ...
      for (;;) { ConcurrentHashMapV8.TreeNode<K, V> xp;
        ...
        if ((!red) || ((xpp = parent) == null))
          return root;
        ConcurrentHashMapV8.TreeNode<K, V> xpp; ConcurrentHashMapV8.TreeNode<K, V> xppl; if (xp == (xppl = left)) { ConcurrentHashMapV8.TreeNode<K, V> xppr;
          if (((xppr = right) != null) && (red)) {
            red = false;
            red = false;
            red = true;
            x = xpp;
            ...
            if (x == right) {
              ...
              xpp = (xp = parent) == null ? null : parent;
            }
            if (xp != null) {
              red = false;
              if (xpp != null) {
    ...
    static <K, V> ConcurrentHashMapV8.TreeNode<K, V> balanceDeletion(ConcurrentHashMapV8.TreeNode<K, V> root, ConcurrentHashMapV8.TreeNode<K, V> x)
    {
      for (;;)
      {
        if ((x == null) || (x == root))
          return root;
        ConcurrentHashMapV8.TreeNode<K, V> xp; if ((xp = parent) == null) {
          red = false;
          return x;
        }
        if (red) {
        ...
        if ((xpl = left) == x) { ConcurrentHashMapV8.TreeNode<K, V> xpr;
          if (((xpr = right) != null) && (red)) {
            red = false;
            red = true;
            root = rotateLeft(root, xp);
            xpr = (xp = parent) == null ? null : right;
          }
          if (xpr == null) {
            x = xp;
          } else {
            ConcurrentHashMapV8.TreeNode<K, V> sl = left;ConcurrentHashMapV8.TreeNode<K, V> sr = right;
            if (((sr == null) || (!red)) && ((sl == null) || (!red)))
            {
              red = true;
              x = xp;
            }
          ...
          if ((xpl != null) && (red)) {
            ...
            xpl = (xp = parent) == null ? null : left;
          }
          if (xpl == null) {
            x = xp;
          } else {
            ConcurrentHashMapV8.TreeNode<K, V> sl = left;ConcurrentHashMapV8.TreeNode<K, V> sr = right;
            if (((sl == null) || (!red)) && ((sr == null) || (!red)))
            {
              red = true;
              x = xp;
            }
    ...
    {
      ConcurrentHashMapV8.TreeNode<K, V> tp = parent;ConcurrentHashMapV8.TreeNode<K, V> tl = left;ConcurrentHashMapV8.TreeNode<K, V> tr = right;
      ConcurrentHashMapV8.TreeNode<K, V> tb = prev;ConcurrentHashMapV8.TreeNode<K, V> tn = (ConcurrentHashMapV8.TreeNode)next;
      if ((tb != null) && (next != t))
        return false;
      if ((tn != null) && (prev != t))
        return false;
      if ((tp != null) && (t != left) && (t != right))
        return false;
      if ((tl != null) && ((parent != t) || (hash > hash)))
        return false;
      if ((tr != null) && ((parent != t) || (hash < hash)))
        return false;
      if ((red) && (tl != null) && (red) && (tr != null) && (red))
        return false;
  ...
  static class Traverser<K, V>
  {
    ...
    final ConcurrentHashMapV8.Node<K, V> advance()
    {
      ...
      for (;;) {
        if (e != null)
          return this.next = e;
        ConcurrentHashMapV8.Node<K, V>[] t; int n; int i; if ((baseIndex >= baseLimit) || ((t = tab) == null) || ((n = t.length) <= (i = index)) || (i < 0))
        {
          return this.next = null; }
        int n; int i; ConcurrentHashMapV8.Node<K, V>[] t; if (((e = ConcurrentHashMapV8.tabAt(t, index)) != null) && (hash < 0)) {
  ...
  static final class EntryIterator<K, V> extends ConcurrentHashMapV8.BaseIterator<K, V> implements Iterator<Map.Entry<K, V>>
  {
    ...
    public final Map.Entry<K, V> next() {
      ...
      lastReturned = p;
      advance();
      return new ConcurrentHashMapV8.MapEntry(k, v, map);
    }
  }
  ...
  static final class MapEntry<K, V> implements Map.Entry<K, V>
  {
    ...
    public boolean equals(Object o) { Map.Entry<?, ?> e;
      Object k;
      Object v; return ((o instanceof Map.Entry)) && ((k = (e = (Map.Entry)o).getKey()) != null) && ((v = e.getValue()) != null) && ((k == key) || (k.equals(key))) && ((v == val) || (v.equals(val)));
    }
  ...
  static final class KeySpliterator<K, V> extends ConcurrentHashMapV8.Traverser<K, V> implements ConcurrentHashMapV8.ConcurrentHashMapSpliterator<K>
  {
    ...
    public ConcurrentHashMapV8.ConcurrentHashMapSpliterator<K> trySplit() { int i;
      int f;
      int h;
      return (h = (i = baseIndex) + (f = baseLimit) >>> 1) <= i ? null : new KeySpliterator(tab, baseSize, this.baseLimit = h, f, this.est >>>= 1);
    }
    ...
    {
      if (action == null) throw new NullPointerException();
      ConcurrentHashMapV8.Node<K, V> p; while ((p = advance()) != null)
        action.apply(key);
    }
  ...
  static final class ValueSpliterator<K, V> extends ConcurrentHashMapV8.Traverser<K, V> implements ConcurrentHashMapV8.ConcurrentHashMapSpliterator<V>
  {
    ...
    public ConcurrentHashMapV8.ConcurrentHashMapSpliterator<V> trySplit() { int i;
      int f;
      int h;
      return (h = (i = baseIndex) + (f = baseLimit) >>> 1) <= i ? null : new ValueSpliterator(tab, baseSize, this.baseLimit = h, f, this.est >>>= 1);
    }
  ...
  static final class EntrySpliterator<K, V> extends ConcurrentHashMapV8.Traverser<K, V> implements ConcurrentHashMapV8.ConcurrentHashMapSpliterator<Map.Entry<K, V>>
  {
    ...
    public ConcurrentHashMapV8.ConcurrentHashMapSpliterator<Map.Entry<K, V>> trySplit() { int i;
      int f;
      int h;
      return (h = (i = baseIndex) + (f = baseLimit) >>> 1) <= i ? null : new EntrySpliterator(tab, baseSize, this.baseLimit = h, f, this.est >>>= 1, map);
    }
    ...
    public void forEachRemaining(ConcurrentHashMapV8.Action<? super Map.Entry<K, V>> action)
    {
      if (action == null) throw new NullPointerException();
      ConcurrentHashMapV8.Node<K, V> p; while ((p = advance()) != null)
        action.apply(new ConcurrentHashMapV8.MapEntry(key, val, map));
    }
  ...
  final int batchFor(long b)
  {
    ...
    if ((b == Long.MAX_VALUE) || ((n = sumCount()) <= 1L) || (n < b))
      return 0;
    long n; int sp = ForkJoinPool.getCommonPoolParallelism() << 2;
  ...
  public double reduceToDouble(long parallelismThreshold, ObjectByObjectToDouble<? super K, ? super V> transformer, double basis, DoubleByDoubleToDouble reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Double)new MapReduceMappingsToDoubleTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).doubleValue();
  }
  ...
  public long reduceToLong(long parallelismThreshold, ObjectByObjectToLong<? super K, ? super V> transformer, long basis, LongByLongToLong reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Long)new MapReduceMappingsToLongTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).longValue();
  }
  ...
  public int reduceToInt(long parallelismThreshold, ObjectByObjectToInt<? super K, ? super V> transformer, int basis, IntByIntToInt reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Integer)new MapReduceMappingsToIntTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).intValue();
  }
  ...
  public double reduceKeysToDouble(long parallelismThreshold, ObjectToDouble<? super K> transformer, double basis, DoubleByDoubleToDouble reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Double)new MapReduceKeysToDoubleTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).doubleValue();
  }
  ...
  public long reduceKeysToLong(long parallelismThreshold, ObjectToLong<? super K> transformer, long basis, LongByLongToLong reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Long)new MapReduceKeysToLongTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).longValue();
  }
  ...
  public int reduceKeysToInt(long parallelismThreshold, ObjectToInt<? super K> transformer, int basis, IntByIntToInt reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Integer)new MapReduceKeysToIntTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).intValue();
  }
  ...
  public double reduceValuesToDouble(long parallelismThreshold, ObjectToDouble<? super V> transformer, double basis, DoubleByDoubleToDouble reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Double)new MapReduceValuesToDoubleTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).doubleValue();
  }
  ...
  public long reduceValuesToLong(long parallelismThreshold, ObjectToLong<? super V> transformer, long basis, LongByLongToLong reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Long)new MapReduceValuesToLongTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).longValue();
  }
  ...
  public int reduceValuesToInt(long parallelismThreshold, ObjectToInt<? super V> transformer, int basis, IntByIntToInt reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Integer)new MapReduceValuesToIntTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).intValue();
  }
  ...
  {
    if (reducer == null) throw new NullPointerException();
    return (Map.Entry)new ReduceEntriesTask(null, batchFor(parallelismThreshold), 0, 0, table, null, reducer).invoke();
  }
  ...
  public double reduceEntriesToDouble(long parallelismThreshold, ObjectToDouble<Map.Entry<K, V>> transformer, double basis, DoubleByDoubleToDouble reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Double)new MapReduceEntriesToDoubleTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).doubleValue();
  }
  ...
  public long reduceEntriesToLong(long parallelismThreshold, ObjectToLong<Map.Entry<K, V>> transformer, long basis, LongByLongToLong reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Long)new MapReduceEntriesToLongTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).longValue();
  }
  ...
  public int reduceEntriesToInt(long parallelismThreshold, ObjectToInt<Map.Entry<K, V>> transformer, int basis, IntByIntToInt reducer)
  {
    if ((transformer == null) || (reducer == null))
      throw new NullPointerException();
    return ((Integer)new MapReduceEntriesToIntTask(null, batchFor(parallelismThreshold), 0, 0, table, null, transformer, basis, reducer).invoke()).intValue();
  }
    ...
    implements Set<K>, Serializable
  {
    ...
    public Iterator<K> iterator()
    {
      ...
      ConcurrentHashMapV8.Node<K, V>[] t; int f = (t = table) == null ? 0 : t.length;
    ...
    public void forEach(ConcurrentHashMapV8.Action<? super K> action) {
      ...
      if ((t = map.table) != null) {
        ...
        ConcurrentHashMapV8.Node<K, V> p; while ((p = it.advance()) != null) {
          action.apply(key);
        }
      }
    }
    ...
    implements Collection<V>, Serializable
  {
    ...
    ValuesView(ConcurrentHashMapV8<K, V> map) { super(); }
    ...
    implements Set<Map.Entry<K, V>>, Serializable
  {
    ...
    EntrySetView(ConcurrentHashMapV8<K, V> map) { super(); }
    
    public boolean contains(Object o) { Map.Entry<?, ?> e;
      Object k;
      Object r; Object v; return ((o instanceof Map.Entry)) && ((k = (e = (Map.Entry)o).getKey()) != null) && ((r = map.get(k)) != null) && ((v = e.getValue()) != null) && ((v == r) || (v.equals(r)));
    }
    ...
    extends CountedCompleter<R>
  {
    ...
    BulkTask(BulkTask<K, V, ?> par, int b, int i, int f, ConcurrentHashMapV8.Node<K, V>[] t)
    {
      super();
      batch = b;
      index = (this.baseIndex = i);
      if ((this.tab = t) == null) {
        baseSize = (this.baseLimit = 0);
      } else if (par == null) {
        baseSize = (this.baseLimit = t.length);
      } else {
        baseLimit = f;
        baseSize = baseSize;
      }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Action<? super K> action;
      if ((action = this.action) != null) { int f;
        int h; for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          addToPendingCount(1);
          new ForEachKeyTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, action).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Action<? super V> action;
      if ((action = this.action) != null) { int f;
        ...
        {
          addToPendingCount(1);
          new ForEachValueTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, action).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Action<? super Map.Entry<K, V>> action;
      if ((action = this.action) != null) { int f;
        ...
        {
          addToPendingCount(1);
          new ForEachEntryTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, action).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.BiAction<? super K, ? super V> action;
      if ((action = this.action) != null) { int f;
        ...
        {
          addToPendingCount(1);
          new ForEachMappingTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, action).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<? super K, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((action = this.action) != null)) { int f;
        int h;
        for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          addToPendingCount(1);
          new ForEachTransformedKeyTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, transformer, action).fork();
        }
        
        ConcurrentHashMapV8.Node<K, V> p;
        while ((p = advance()) != null) {
          U u;
          if ((u = transformer.apply(key)) != null)
            action.apply(u);
        }
        propagateCompletion();
      }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<? super V, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((action = this.action) != null)) { int f;
        ...
        {
          addToPendingCount(1);
          new ForEachTransformedValueTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, transformer, action).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<Map.Entry<K, V>, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((action = this.action) != null)) { int f;
        ...
        {
          addToPendingCount(1);
          new ForEachTransformedEntryTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, transformer, action).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Void>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.BiFun<? super K, ? super V, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((action = this.action) != null)) { int f;
        ...
        {
          addToPendingCount(1);
          new ForEachTransformedMappingTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, transformer, action).fork();
        }
        
        ConcurrentHashMapV8.Node<K, V> p;
        while ((p = advance()) != null) {
          U u;
          if ((u = transformer.apply(key, val)) != null)
            action.apply(u);
        }
        propagateCompletion();
      }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, U>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<? super K, ? extends U> searchFunction;
      ...
      if (((searchFunction = this.searchFunction) != null) && ((result = this.result) != null)) { int f;
        int h;
        for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          if (result.get() != null)
            return;
          addToPendingCount(1);
          new SearchKeysTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, searchFunction, result).fork();
        }
        ...
        while (result.get() == null)
        {
          ...
          if ((p = advance()) == null) {
            ...
            break; }
          U u;
          if ((u = searchFunction.apply(key)) != null) {
      ...
      if (((searchFunction = this.searchFunction) != null) && ((result = this.result) != null)) { int f;
        ...
        for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          if (result.get() != null)
            return;
          addToPendingCount(1);
          new SearchValuesTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, searchFunction, result).fork();
        }
        ...
        while (result.get() == null)
        {
          ...
          if ((p = advance()) == null) {
            ...
            break; }
          U u;
          if ((u = searchFunction.apply(val)) != null) {
            if (!result.compareAndSet(null, u)) break;
            quietlyCompleteRoot(); break;
          }
        }
      ...
      if (((searchFunction = this.searchFunction) != null) && ((result = this.result) != null)) { int f;
        ...
        for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          if (result.get() != null)
            return;
          addToPendingCount(1);
          new SearchEntriesTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, searchFunction, result).fork();
        }
      ...
      if (((searchFunction = this.searchFunction) != null) && ((result = this.result) != null)) { int f;
        ...
        for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          if (result.get() != null)
            return;
          addToPendingCount(1);
          new SearchMappingsTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, searchFunction, result).fork();
        }
        ...
        while (result.get() == null)
        {
          ...
          if ((p = advance()) == null) {
            ...
            break; }
          U u;
          if ((u = searchFunction.apply(key, val)) != null) {
            if (!result.compareAndSet(null, u)) break;
            quietlyCompleteRoot(); break;
          }
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, K>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.BiFun<? super K, ? super K, ? extends K> reducer;
      if ((reducer = this.reducer) != null) { int f;
        int h; for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          addToPendingCount(1);
          (this.rights = new ReduceKeysTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, reducer)).fork();
        }
        ...
        for (CountedCompleter<?> c = firstComplete(); c != null; c = c.nextComplete())
        {
          ...
          while (s != null) {
            K sr;
            if ((sr = result) != null) { K tr;
              result = ((tr = result) == null ? sr : reducer.apply(tr, sr));
            }
            s = t.rights = nextRight;
          }
        }
      }
    }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, V>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.BiFun<? super V, ? super V, ? extends V> reducer;
      if ((reducer = this.reducer) != null) { int f;
        ...
        {
          addToPendingCount(1);
          (this.rights = new ReduceValuesTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Map.Entry<K, V>>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.BiFun<Map.Entry<K, V>, Map.Entry<K, V>, ? extends Map.Entry<K, V>> reducer;
      if ((reducer = this.reducer) != null) { int f;
        ...
        {
          addToPendingCount(1);
          (this.rights = new ReduceEntriesTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, reducer)).fork();
        }
        ...
        for (CountedCompleter<?> c = firstComplete(); c != null; c = c.nextComplete())
        {
          ...
          while (s != null) {
            Map.Entry<K, V> sr;
            if ((sr = result) != null) { Map.Entry<K, V> tr;
              result = ((tr = result) == null ? sr : (Map.Entry)reducer.apply(tr, sr));
            }
            s = t.rights = nextRight;
          }
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, U>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<? super K, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null)) { int f;
        int h;
        for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          addToPendingCount(1);
          (this.rights = new MapReduceKeysTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, U>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<? super V, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null)) { int f;
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceValuesTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, U>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.Fun<Map.Entry<K, V>, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null)) { int f;
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceEntriesTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, U>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.BiFun<? super K, ? super V, ? extends U> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null)) { int f;
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceMappingsTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Double>
  {
    ...
    public final Double getRawResult() { return Double.valueOf(result); }
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToDouble<? super K> transformer;
      ...
      {
        double r = basis;
        int f; int h; for (int i = baseIndex; (batch > 0) && ((h = (f = baseLimit) + i >>> 1) > i);)
        {
          addToPendingCount(1);
          (this.rights = new MapReduceKeysToDoubleTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
        
        ConcurrentHashMapV8.Node<K, V> p;
        while ((p = advance()) != null)
          r = reducer.apply(r, transformer.apply(key));
        result = r;
        ...
        for (CountedCompleter<?> c = firstComplete(); c != null; c = c.nextComplete())
        {
          ...
          while (s != null) {
            result = reducer.apply(result, result);
            s = t.rights = nextRight;
          }
        }
      }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Double>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToDouble<? super V> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceValuesToDoubleTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
        
        ConcurrentHashMapV8.Node<K, V> p;
        while ((p = advance()) != null)
          r = reducer.apply(r, transformer.apply(val));
        result = r;
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Double>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToDouble<Map.Entry<K, V>> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceEntriesToDoubleTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Double>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectByObjectToDouble<? super K, ? super V> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceMappingsToDoubleTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
        
        ConcurrentHashMapV8.Node<K, V> p;
        while ((p = advance()) != null)
          r = reducer.apply(r, transformer.apply(key, val));
        result = r;
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Long>
  {
    ...
    public final Long getRawResult() { return Long.valueOf(result); }
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToLong<? super K> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceKeysToLongTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Long>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToLong<? super V> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceValuesToLongTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Long>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToLong<Map.Entry<K, V>> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceEntriesToLongTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Long>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectByObjectToLong<? super K, ? super V> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceMappingsToLongTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Integer>
  {
    ...
    public final Integer getRawResult() { return Integer.valueOf(result); }
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToInt<? super K> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceKeysToIntTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Integer>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToInt<? super V> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceValuesToIntTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Integer>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectToInt<Map.Entry<K, V>> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceEntriesToIntTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
    ...
    extends ConcurrentHashMapV8.BulkTask<K, V, Integer>
  {
    ...
    public final void compute() { ConcurrentHashMapV8.ObjectByObjectToInt<? super K, ? super V> transformer;
      ...
      if (((transformer = this.transformer) != null) && ((reducer = this.reducer) != null))
      {
        ...
        {
          addToPendingCount(1);
          (this.rights = new MapReduceMappingsToIntTask(this, this.batch >>>= 1, this.baseLimit = h, f, tab, rights, transformer, r, reducer)).fork();
        }
  ...
  final long sumCount()
  {
    ...
    long sum = baseCount;
    if (as != null) {
      for (int i = 0; i < as.length; i++) { CounterCell a;
        if ((a = as[i]) != null)
          sum += value;
      }
    }
  ...
  private final void fullAddCount(InternalThreadLocalMap threadLocals, long x, IntegerHolder hc, boolean wasUncontended)
  {
    ...
    for (;;) { CounterCell[] as;
      int n;
      if (((as = counterCells) != null) && ((n = as.length) > 0)) { CounterCell a;
        if ((a = as[(n - 1 & h)]) == null) {
          if (cellsBusy == 0) {
            ...
            if ((cellsBusy == 0) && (U.compareAndSwapInt(this, CELLSBUSY, 0, 1)))
            {
              ...
              try { CounterCell[] rs;
                int m;
                int j; if (((rs = counterCells) != null) && ((m = rs.length) > 0) && (rs[(j = m - 1 & h)] == null))
                {
          ...
          if (U.compareAndSwapLong(a, CELLVALUE, v = value, v + x))
            break;
          if ((counterCells != as) || (n >= NCPU)) {
            collide = false;
          } else if (!collide) {
            collide = true;
      ...
      else if ((cellsBusy == 0) && (counterCells == as) && (U.compareAndSwapInt(this, CELLSBUSY, 0, 1)))
      {
        ...
        if (U.compareAndSwapLong(this, BASECOUNT, v = baseCount, v + x)) break;
      }
    }
    value = h;
  }
  ...
  static
  {
    try
    {
      ...
      Class<?> ak = [Lio.netty.util.internal.chmv8.ConcurrentHashMapV8.Node.class;

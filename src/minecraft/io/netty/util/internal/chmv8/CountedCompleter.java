  ...
  extends ForkJoinTask<T>
{
  ...
  public final CountedCompleter<?> getRoot()
  {
    ...
    CountedCompleter<?> p; while ((p = completer) != null)
      a = p;
    return a;
  }
  ...
  public void complete(T rawResult)
  {
    ...
    onCompletion(this);
    quietlyComplete();
    CountedCompleter<?> p; if ((p = completer) != null) {
      p.tryComplete();
    }
  }
  ...
  {
    CountedCompleter<?> a = this;
    for (;;) { CountedCompleter<?> p; if ((p = completer) == null) {
        a.quietlyComplete();
        return;
      }
      a = p;
  ...
  void internalPropagateException(Throwable ex)
  {
    ...
    while ((a.onExceptionalCompletion(ex, s)) && ((a = completer) != null) && (status >= 0) && (a.recordExceptionalCompletion(ex) == Integer.MIN_VALUE)) {}
  }

  ...
  extends AbstractNioChannel
{
  ...
  protected AbstractNioChannel.AbstractNioUnsafe newUnsafe() { return new NioByteUnsafe(null); }
  
  private final class NioByteUnsafe extends AbstractNioChannel.AbstractNioUnsafe {
    private NioByteUnsafe() { super(); }
    ...
    private void closeOnRead(ChannelPipeline pipeline) {
      ...
      if (isOpen()) {
        if (Boolean.TRUE.equals(config().getOption(ChannelOption.ALLOW_HALF_CLOSURE))) {
          key.interestOps(key.interestOps() & (readInterestOp ^ 0xFFFFFFFF));
    ...
    public void read()
    {
      ...
      try {
        ...
        do {
          ...
          messages++; } while (messages < maxMessagesPerRead);

  ...
  implements ChannelHandlerContext
{
  ...
  public ChannelHandlerContext fireChannelReadComplete()
  {
    ...
    if (executor.inEventLoop()) {
      ...
      Runnable task = invokeChannelReadCompleteTask;
      if (task == null) {
        invokeChannelReadCompleteTask = (task = new Runnable()
        {
          public void run() {
            next.invokeChannelReadComplete();
          }
  ...
  public ChannelHandlerContext fireChannelWritabilityChanged()
  {
    ...
    if (executor.inEventLoop()) {
      ...
      Runnable task = invokeChannelWritableStateChangedTask;
      if (task == null) {
        invokeChannelWritableStateChangedTask = (task = new Runnable()
        {
          public void run() {
            next.invokeChannelWritabilityChanged();
          }
  ...
  public ChannelFuture bind(final SocketAddress localAddress, final ChannelPromise promise)
  {
    ...
    if (executor.inEventLoop()) {
      ...
      safeExecute(executor, new OneTimeTask()
      {
        ...
        public void run() { next.invokeBind(localAddress, promise); } }, promise, null);
    }
  ...
  public ChannelFuture connect(final SocketAddress remoteAddress, final SocketAddress localAddress, final ChannelPromise promise)
  {
    ...
    if (executor.inEventLoop()) {
      ...
      safeExecute(executor, new OneTimeTask()
      {
        ...
        public void run() { next.invokeConnect(remoteAddress, localAddress, promise); } }, promise, null);
    }
      ...
      safeExecute(executor, new OneTimeTask()
      {
        public void run() {
          if (!channel().metadata().hasDisconnect()) {
            ...
            next.invokeDisconnect(promise); } }, promise, null);
    }
  ...
  public ChannelFuture close(final ChannelPromise promise)
  {
    ...
    if (executor.inEventLoop()) {
      ...
      safeExecute(executor, new OneTimeTask()
      {
        ...
        public void run() { next.invokeClose(promise); } }, promise, null);
    }
  ...
  public ChannelFuture deregister(final ChannelPromise promise)
  {
    ...
    if (executor.inEventLoop()) {
      ...
      safeExecute(executor, new OneTimeTask()
      {
        ...
        public void run() { next.invokeDeregister(promise); } }, promise, null);
    }
  ...
  public ChannelHandlerContext read()
  {
    ...
    if (executor.inEventLoop()) {
      ...
      Runnable task = invokeReadTask;
      if (task == null) {
        invokeReadTask = (task = new Runnable()
        {
          public void run() {
            next.invokeRead();
          }
  ...
  public ChannelHandlerContext flush()
  {
    ...
    if (executor.inEventLoop()) {
      ...
      Runnable task = invokeFlushTask;
      if (task == null) {
        invokeFlushTask = (task = new Runnable()
        {
          public void run() {
            next.invokeFlush();
          }

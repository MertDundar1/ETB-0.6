...
final class Native
{
  ...
  static { String name = SystemPropertyUtil.get("os.name").toLowerCase(Locale.UK).trim();
  ...
  private static class NativeInetAddress { NativeInetAddress(byte[] address, int scopeId) { this.address = address;
      this.scopeId = scopeId; }
    
    final byte[] address;
    final int scopeId;
    NativeInetAddress(byte[] address) { this(address, 0); }
  }

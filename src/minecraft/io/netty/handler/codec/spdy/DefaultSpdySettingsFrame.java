  ...
  implements SpdySettingsFrame
{
  ...
  public int getValue(int id)
  {
    ...
    if (settingsMap.containsKey(key)) {
      return ((Setting)settingsMap.get(key)).getValue();
    }
    return -1;
  }
  ...
  public boolean isPersistValue(int id)
  {
    Integer key = Integer.valueOf(id);
    if (settingsMap.containsKey(key)) {
      return ((Setting)settingsMap.get(key)).isPersist();
    }
    return false;
  }
  ...
  public SpdySettingsFrame setPersistValue(int id, boolean persistValue)
  {
    Integer key = Integer.valueOf(id);
    if (settingsMap.containsKey(key)) {
      ((Setting)settingsMap.get(key)).setPersist(persistValue);
    }
    return this;
  }
  ...
  public boolean isPersisted(int id)
  {
    Integer key = Integer.valueOf(id);
    if (settingsMap.containsKey(key)) {
      return ((Setting)settingsMap.get(key)).isPersisted();
    }
    return false;
  }
  ...
  public SpdySettingsFrame setPersisted(int id, boolean persisted)
  {
    Integer key = Integer.valueOf(id);
    if (settingsMap.containsKey(key)) {
      ((Setting)settingsMap.get(key)).setPersisted(persisted);
    }
    return this;
  }

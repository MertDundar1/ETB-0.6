  ...
  extends CookieEncoder
{
  ...
  private List<String> dedup(List<String> encoded, Map<String, Integer> nameToLastIndex)
  {
    ...
    for (Iterator i$ = nameToLastIndex.values().iterator(); i$.hasNext();) { int idx = ((Integer)i$.next()).intValue();
  ...
  public List<String> encode(Iterable<? extends Cookie> cookies)
  {
    ...
    boolean hasDupdName = nameToIndex.put(firstCookie.name(), Integer.valueOf(i++)) != null;

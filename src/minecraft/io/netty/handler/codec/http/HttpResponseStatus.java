  ...
  implements Comparable<HttpResponseStatus>
{
  ...
  public static HttpResponseStatus valueOf(int code)
  {
    ...
    String reasonPhrase;
    if (code < 100) {
      reasonPhrase = "Unknown Status"; } else { String reasonPhrase;
      if (code < 200) {
        reasonPhrase = "Informational"; } else { String reasonPhrase;
        if (code < 300) {
          reasonPhrase = "Successful"; } else { String reasonPhrase;
          if (code < 400) {
            reasonPhrase = "Redirection"; } else { String reasonPhrase;
            if (code < 500) {
              reasonPhrase = "Client Error"; } else { String reasonPhrase;
              if (code < 600) {

  ...
  extends DeflateDecoder
{
  ...
  {
    return ((!(msg instanceof TextWebSocketFrame)) && (!(msg instanceof BinaryWebSocketFrame))) || (((((WebSocketFrame)msg).rsv() & 0x4) > 0) || (((msg instanceof ContinuationWebSocketFrame)) && (compressing)));
  }

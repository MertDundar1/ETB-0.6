  ...
  public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception
  {
    ...
    try {
      if (acceptOutboundMessage(msg)) {
        ...
        ctx.write(msg, promise); } } catch (EncoderException e) { int sizeMinusOne;
      ChannelPromise voidPromise;
      boolean isVoidPromise;
      int i; ChannelPromise p; ChannelPromise p; throw e;
    } catch (Throwable t) {
      ...
      if (out != null) {
        ...
        } else if (sizeMinusOne > 0)
        {
          ...
          for (int i = 0; i < sizeMinusOne; i++) { ChannelPromise p;
            ChannelPromise p;
            if (isVoidPromise) {
              p = voidPromise;
            } else {

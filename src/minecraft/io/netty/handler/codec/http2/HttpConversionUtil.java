...
public final class HttpConversionUtil
{
  ...
  public static FullHttpResponse toHttpResponse(int streamId, Http2Headers http2Headers, ByteBufAllocator alloc, boolean validateHttpHeaders)
    throws Http2Exception
  {
    ...
    public void translate(Map.Entry<CharSequence, CharSequence> entry) throws Http2Exception {
      ...
      } else if (!Http2Headers.PseudoHeaderName.isPseudoHeader(name))
      {
        ...
        if (HttpHeaderNames.COOKIE.equals(name))
        {
          ...
          output.set(HttpHeaderNames.COOKIE, existingCookie != null ? existingCookie + "; " + value : value);
        }
        else {

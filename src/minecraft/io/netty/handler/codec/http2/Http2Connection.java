...
public abstract interface Http2Connection
{
  ...
  public abstract void goAwaySent(int paramInt, long paramLong, ByteBuf paramByteBuf);
  ...
  public static abstract interface Endpoint<F extends Http2FlowController>
  {
    ...
    public abstract Http2Stream createIdleStream(int paramInt)
      throws Http2Exception;
    ...
    public abstract void maxStreams(int paramInt1, int paramInt2)
      throws Http2Exception;
  ...
  public static abstract interface Listener
  {
    ...
    public abstract void onPriorityTreeParentChanged(Http2Stream paramHttp2Stream1, Http2Stream paramHttp2Stream2);
    
    public abstract void onPriorityTreeParentChanging(Http2Stream paramHttp2Stream1, Http2Stream paramHttp2Stream2);

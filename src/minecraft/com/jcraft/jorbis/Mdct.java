...
class Mdct
{
  ...
  void init(int n)
  {
    ...
    log2n = ((int)Math.rint(Math.log(n) / Math.log(2.0D)));
    this.n = n;
    ...
    for (int i = 0; i < n / 4; i++) {
      trig[(AE + i * 2)] = ((float)Math.cos(3.141592653589793D / n * (4 * i)));
      trig[(AO + i * 2)] = ((float)-Math.sin(3.141592653589793D / n * (4 * i)));
      trig[(BE + i * 2)] = ((float)Math.cos(3.141592653589793D / (2 * n) * (2 * i + 1)));
      trig[(BO + i * 2)] = ((float)Math.sin(3.141592653589793D / (2 * n) * (2 * i + 1)));
    }
    for (int i = 0; i < n / 8; i++) {
      trig[(CE + i * 2)] = ((float)Math.cos(3.141592653589793D / n * (4 * i + 2)));
      trig[(CO + i * 2)] = ((float)-Math.sin(3.141592653589793D / n * (4 * i + 2)));
    }
  ...
  synchronized void backward(float[] in, float[] out) {
    ...
    int B = n2;
    int o1 = n4;int o2 = o1 - 1;
    int o3 = n4 + n2;int o4 = o3 - 1;

  ...
  extends GuiScreen
{
  ...
  public void drawScreen(int par1, int par2, float par3)
  {
    ...
    mcfontRendererObj.drawCenteredString("Edit Alt", width / 2, 10, -1);
    mcfontRendererObj.drawCenteredString(status, width / 2, 20, -1);
    nameField.drawTextBox();
    pwField.drawTextBox();
    if (nameField.getText().isEmpty())
      mcfontRendererObj.drawStringWithShadow("New E-Mail", width / 2 - 96, 66.0F, -7829368);
    if (pwField.getText().isEmpty())
      mcfontRendererObj.drawStringWithShadow("New Password", width / 2 - 96, 106.0F, -7829368);

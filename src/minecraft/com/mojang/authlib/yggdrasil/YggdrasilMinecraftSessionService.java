...
public class YggdrasilMinecraftSessionService extends HttpMinecraftSessionService
{
  ...
  private final Gson gson = new GsonBuilder().registerTypeAdapter(java.util.UUID.class, new UUIDTypeAdapter()).create();
  ...
  public Map<MinecraftProfileTexture.Type, MinecraftProfileTexture> getTextures(GameProfile profile, boolean requireSecure)
  {
    ...
    try
    {
      String json = new String(org.apache.commons.codec.binary.Base64.decodeBase64(textureProperty.getValue()), org.apache.commons.codec.Charsets.UTF_8);

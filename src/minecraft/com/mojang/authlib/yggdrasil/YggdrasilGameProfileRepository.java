...
public class YggdrasilGameProfileRepository implements GameProfileRepository
{
  ...
  public void findProfilesByNames(String[] names, Agent agent, ProfileLookupCallback callback)
  {
    ...
    for (java.util.List<String> request : com.google.common.collect.Iterables.partition(criteria, 2)) {
      int failCount = 0;
      boolean failed;
      do
      {
        ...
        try
        {
          ProfileSearchResultsResponse response = (ProfileSearchResultsResponse)authenticationService.makeRequest(com.mojang.authlib.HttpAuthenticationService.constantURL("https://api.mojang.com/profiles/" + agent.getName().toLowerCase()), request, ProfileSearchResultsResponse.class);
          failCount = 0;

...
public abstract class HttpAuthenticationService extends BaseAuthenticationService
{
  ...
  public static String buildQuery(java.util.Map<String, Object> query)
  {
    ...
    for (Map.Entry<String, Object> entry : query.entrySet()) {
      ...
      try
      {
        builder.append(java.net.URLEncoder.encode((String)entry.getKey(), "UTF-8"));
      ...
      if (entry.getValue() != null) {
        builder.append('=');
        try {
          builder.append(java.net.URLEncoder.encode(entry.getValue().toString(), "UTF-8"));
        } catch (UnsupportedEncodingException e) {
          LOGGER.error("Unexpected exception building query", e);
        }
      }

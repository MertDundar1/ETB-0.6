...
public class RealmsClient
{
  ...
  public com.mojang.realmsclient.dto.ServerActivityList getActivity(long worldId) throws RealmsServiceException {
    String asciiUrl = url("activities" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(worldId)));
    String json = execute(Request.get(asciiUrl));
    return com.mojang.realmsclient.dto.ServerActivityList.parse(json);
  }
  
  public com.mojang.realmsclient.dto.RealmsServerAddress join(long worldId) throws RealmsServiceException, IOException {
    String asciiUrl = url("worlds" + "/$ID/join".replace("$ID", new StringBuilder().append("").append(worldId).toString()));
  ...
  public com.mojang.realmsclient.dto.BackupList backupsFor(long worldId) throws RealmsServiceException {
    String asciiUrl = url("worlds" + "/$WORLD_ID/backups".replace("$WORLD_ID", String.valueOf(worldId)));
    String json = execute(Request.get(asciiUrl));
    return com.mojang.realmsclient.dto.BackupList.parse(json);
  }
  
  public void update(long worldId, String name, String motd) throws RealmsServiceException, java.io.UnsupportedEncodingException {
  ...
  public void updateSlot(long worldId, RealmsOptions options) throws RealmsServiceException, java.io.UnsupportedEncodingException {
  ...
  public com.mojang.realmsclient.dto.Subscription subscriptionFor(long worldId) throws RealmsServiceException, IOException {
    String asciiUrl = url("subscriptions" + "/$WORLD_ID".replace("$WORLD_ID", String.valueOf(worldId)));
    String json = execute(Request.get(asciiUrl));
    return com.mojang.realmsclient.dto.Subscription.parse(json);
  }
  ...
  public com.mojang.realmsclient.dto.RealmsState fetchRealmsState() throws RealmsServiceException {
    String asciiUrl = url("mco/buy");
    String json = execute(Request.get(asciiUrl));
    return com.mojang.realmsclient.dto.RealmsState.parse(json);
  }
  ...
  public void sendPingResults(com.mojang.realmsclient.dto.PingResult pingResult) throws RealmsServiceException {
  ...
  {
    r.cookie("sid", sessionId);
    r.cookie("user", username);
    r.cookie("version", net.minecraft.realms.RealmsSharedConstants.VERSION_STRING);
    String realmsVersion = com.mojang.realmsclient.RealmsVersion.getVersion();
    ...
    try
    {
      ...
      if (responseCode == 503) {
        ...
        throw new com.mojang.realmsclient.exception.RetryCallException(pauseTime);
      }

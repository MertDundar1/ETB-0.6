...
public class RealmsTermsScreen extends RealmsScreen
{
  ...
  private void agreedToTos() {
    ...
    try {
      client.agreeToTos();
      RealmsLongRunningMcoTaskScreen longRunningMcoTaskScreen = new RealmsLongRunningMcoTaskScreen(lastScreen, new RealmsTasks.RealmsConnectTask(lastScreen, realmsServer));
  ...
  public void mouseClicked(int x, int y, int buttonNum)
  {
    ...
    if (onLink) {
      ...
      clipboard.setContents(new StringSelection(realmsToSUrl), null);
      RealmsUtil.browseTo(realmsToSUrl);
    }
  }

  ...
  extends ValueObject
{
  ...
  public static RealmsServerList parse(String json) { RealmsServerList list = new RealmsServerList();
    ...
    try {
      ...
      if (object.get("servers").isJsonArray()) {
        ...
        while (it.hasNext()) {
          servers.add(RealmsServer.parse(((JsonElement)it.next()).getAsJsonObject()));
        }
      }
    } catch (Exception e) {

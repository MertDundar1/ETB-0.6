...
public final class UScript
{
  ...
  private static int[] findCodeFromLocale(ULocale locale)
  {
    ...
    UResourceBundle sub = rb.get("LocaleScript");
  ...
  public static final int getScript(int codepoint)
  {
    if (((codepoint >= 0 ? 1 : 0) & (codepoint <= 1114111 ? 1 : 0)) != 0) {
      ...
      return INSTANCEm_scriptExtensions_[(scriptX & 0xFF)];
    }
  ...
  public static final boolean hasScript(int c, int sc)
  {
    ...
    char[] scriptExtensions = INSTANCEm_scriptExtensions_;

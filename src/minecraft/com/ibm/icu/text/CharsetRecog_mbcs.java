  ...
  extends CharsetRecognizer
{
  ...
  static class iteratedChar
  {
    ...
    int nextByte(CharsetDetector det) {
      if (nextIndex >= fRawLength) {
        done = true;
        return -1;
      }
      int byteValue = fRawInput[(nextIndex++)] & 0xFF;
      return byteValue;
    }
  }
    ...
    extends CharsetRecog_mbcs
  {
    ...
    boolean nextChar(CharsetRecog_mbcs.iteratedChar it, CharsetDetector det)
    {
      ...
      charValue = (firstByte << 8 | secondByte);
    ...
    extends CharsetRecog_mbcs
  {
    ...
    boolean nextChar(CharsetRecog_mbcs.iteratedChar it, CharsetDetector det)
    {
      ...
      charValue = (charValue << 8 | secondByte);
    ...
    boolean nextChar(CharsetRecog_mbcs.iteratedChar it, CharsetDetector det)
    {
      ...
      else if (firstByte > 141)
      {
        ...
        else if (firstByte == 143)
        {
          ...
          charValue = (charValue << 8 | thirdByte);
          if (thirdByte < 161) {
            error = true;
          }
        }
            ...
            if ((secondByte >= 48) && (secondByte <= 57)) {
              ...
              if ((thirdByte >= 129) && (thirdByte <= 254)) {
                ...
                if ((fourthByte >= 48) && (fourthByte <= 57)) {
                  charValue = (charValue << 16 | thirdByte << 8 | fourthByte);

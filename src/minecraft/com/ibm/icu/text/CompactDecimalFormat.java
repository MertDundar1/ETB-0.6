  ...
  extends DecimalFormat
{
  ...
  CompactDecimalFormat(ULocale locale, CompactStyle style)
  {
    ...
    currencyAffixes = new String[2];
    currencyAffixes[0] = currencyFormat.getPositivePrefix();
    currencyAffixes[1] = currencyFormat.getPositiveSuffix();
    setCurrency(null);
  }
  ...
  public CompactDecimalFormat(String pattern, DecimalFormatSymbols formatSymbols, String[] prefix, String[] suffix, long[] divisor, Collection<String> debugCreationErrors, CompactStyle style, String[] currencyAffixes)
  {
    ...
    for (int i = 0; i < prefix.length; i++) {
      ...
      long roundTrip = Math.pow(10.0D, log);
    ...
    units = otherPluralVariant(prefix, suffix);
  ...
  public boolean equals(Object obj)
  {
    ...
    return (mapsAreEqual(units, units)) && (Arrays.equals(divisor, divisor)) && (Arrays.equals(currencyAffixes, currencyAffixes)) && (pluralRules.equals(pluralRules));
  }
  ...
  private CompactDecimalDataCache.Data getData(ULocale locale, CompactStyle style)
  {
    ...
    switch (1.$SwitchMap$com$ibm$icu$text$CompactDecimalFormat$CompactStyle[style.ordinal()]) {
    case 1: 
      return shortData;
    case 2: 
      return longData;

  ...
  implements LanguageBreakEngine
{
  ...
  static { fHangulWordSet.applyPattern("[\\uac00-\\ud7a3]");
  ...
  public CjkBreakEngine(boolean korean) throws IOException { fDictionary = DictionaryData.loadDictionaryFor("Hira");
    if (korean) {
  ...
  public boolean handles(int c, int breakType) {
    return (breakType == 1) && (fWordSet.contains(c));
  }

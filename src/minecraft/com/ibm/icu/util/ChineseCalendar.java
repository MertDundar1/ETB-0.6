  ...
  extends Calendar
{
  ...
  {
    this(TimeZone.getDefault(), ULocale.getDefault(ULocale.Category.FORMAT), 62900, CHINA_ZONE);
  }
  ...
  {
    this(TimeZone.getDefault(), ULocale.forLocale(aLocale), 62900, CHINA_ZONE);
  }
  ...
  {
    this(zone, ULocale.getDefault(ULocale.Category.FORMAT), 62900, CHINA_ZONE);
  }
  ...
  {
    this(zone, ULocale.forLocale(aLocale), 62900, CHINA_ZONE);
  }
  ...
  {
    this(TimeZone.getDefault(), locale, 62900, CHINA_ZONE);
  }
  ...
  {
    this(zone, locale, 62900, CHINA_ZONE);
  }
  ...
  private static final int[][] LIMITS = { { 1, 1, 83333, 83333 }, { 1, 1, 60, 60 }, { 0, 0, 11, 11 }, { 1, 1, 50, 55 }, new int[0], { 1, 1, 29, 30 }, { 1, 1, 353, 385 }, new int[0], { -1, -1, 5, 5 }, new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], new int[0], { -5000000, -5000000, 5000000, 5000000 }, new int[0], { -5000000, -5000000, 5000000, 5000000 }, new int[0], new int[0], { 0, 0, 1, 1 } };
  ...
  protected int handleGetExtendedYear()
  {
    ...
    if (newestStamp(0, 1, 0) <= getStamp(19)) {
      ...
      year = cycle * 60 + internalGet(1, 1) - (epochYear - 62900);
    }
    return year;
  }
  ...
  static final int[][][] CHINESE_DATE_PRECEDENCE = { { { 5 }, { 3, 7 }, { 4, 7 }, { 8, 7 }, { 3, 18 }, { 4, 18 }, { 8, 18 }, { 6 }, { 37, 22 } }, { { 3 }, { 4 }, { 8 }, { 40, 7 }, { 40, 18 } } };
  ...
  {
    return (int)floorDivide(millis + zoneAstro.getOffset(millis), 86400000L);
  }
  ...
  private void computeChineseFields(int days, int gyear, int gmonth, boolean setAllFields)
  {
    ...
    int solsticeBefore; int solsticeBefore; if (days < solsticeAfter) {

...
public final class UniversalTimeScale
{
  ...
  private static final class TimeScaleData
  {
    ...
    TimeScaleData(long theUnits, long theEpochOffset, long theToMin, long theToMax, long theFromMin, long theFromMax)
    {
      ...
      if (theUnits == 1L) {
        epochOffsetP1 = (this.epochOffsetM1 = epochOffset);
      } else {
        epochOffsetP1 = (epochOffset + 1L);
        epochOffsetM1 = (epochOffset - 1L);
      }
  ...
  public static long from(long otherTime, int timeScale)
  {
    ...
    return (otherTime + epochOffset) * units;
  }
  ...
  public static BigDecimal bigDecimalFrom(double otherTime, int timeScale)
  {
    ...
    BigDecimal units = new BigDecimal(units);
    BigDecimal epochOffset = new BigDecimal(epochOffset);
  ...
  public static long toLong(long universalTime, int timeScale)
  {
    ...
    if (universalTime < 0L) {
      if (universalTime < minRound) {
        return (universalTime + unitsRound) / units - epochOffsetP1;
      }
      
      return (universalTime - unitsRound) / units - epochOffset;
    }
    
    if (universalTime > maxRound) {
      return (universalTime - unitsRound) / units - epochOffsetM1;
    }
  ...
  public static long getTimeScaleValue(int scale, int value)
  {
    ...
    case 6: 
      return epochOffsetP1;
    
    case 7: 
      return epochOffsetM1;
  ...
  private static TimeScaleData toRangeCheck(long universalTime, int scale)
  {
    ...
    if ((universalTime >= toMin) && (universalTime <= toMax)) {
      return data;
    }

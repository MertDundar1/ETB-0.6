  ...
  extends UResourceBundle
{
  ...
  public void setLoadingStatus(int newStatus) { loadingStatus = newStatus; }
        ...
        if (!skipScan.equalsIgnoreCase("true")) {
          try
          {
            ...
            while (urls.hasMoreElements()) {
              ...
              else if (ICUResourceBundle.DEBUG) { System.out.println("handler for " + url + " is null");
              }
            }
          } catch (IOException e) {
            if (ICUResourceBundle.DEBUG) System.out.println("ouch: " + e.getMessage());
            resList = null;
          }
        }
  ...
  private static final class AvailEntry
  {
    ...
    Locale[] getLocaleList() { if (locales == null) {
        synchronized (this) {
          if (locales == null) {
            locales = ICUResourceBundle.createLocaleList(prefix, loader);
          }
        }
      }
      return locales;
    ...
    Set<String> getLocaleNameSet() { if (nameSet == null) {
        synchronized (this) {
          if (nameSet == null) {
  ...
  private static CacheBase<String, AvailEntry, ClassLoader> GET_AVAILABLE_CACHE = new SoftCache()
  {
  ...
  private static AvailEntry getAvailEntry(String key, ClassLoader loader) { return (AvailEntry)GET_AVAILABLE_CACHE.getInstance(key, loader); }
  ...
  protected static final ICUResourceBundle findResourceWithFallback(String path, UResourceBundle actualBundle, UResourceBundle requested)
  {
    ...
    String basePath = resPath.length() > 0 ? resPath : "";
  ...
  UResourceBundle get(String aKey, HashMap<String, String> table, UResourceBundle requested) { ICUResourceBundle obj = (ICUResourceBundle)handleGet(aKey, table, requested);
    if (obj == null) {
  ...
  private static final int[] gPublicTypes = { 0, 1, 2, 3, 2, 2, 0, 7, 8, 8, -1, -1, -1, -1, 14, -1 };
  ...
  private static ICUResourceBundle getBundle(ICUResourceBundleReader reader, String baseName, String localeID, ClassLoader loader)
  {
    ...
    ICUResourceBundleImpl bundle; if (gPublicTypes[ICUResourceBundleReader.RES_GET_TYPE(rootRes)] == 2) {
    ...
    baseName = baseName;
    localeID = localeID;
    ulocale = new ULocale(localeID);
    loader = loader;
    UResourceBundle alias = bundle.handleGetImpl("%%ALIAS", null, bundle, null, null);
    if (alias != null) {
  ...
  protected ICUResourceBundle findResource(String key, String resPath, int _resource, HashMap<String, String> table, UResourceBundle requested)
  {
    ...
    String locale = null;String keyPath = null;
    ...
    table.put(rpath, "");
    String bundleName; if (rpath.indexOf('/') == 0) {
      int i = rpath.indexOf('/', 1);
      int j = rpath.indexOf('/', i + 1);
      String bundleName = rpath.substring(1, i);
      if (j < 0) {
  ...
  {
    lookup = new SimpleCache(1, Math.max(getSize() * 2, 64));
  }
  ...
  protected UResourceBundle handleGet(String resKey, HashMap<String, String> table, UResourceBundle requested) {
    ...
    if (res == null) {
      ...
      if ((res != null) && (lookup != null) && (alias[0] == 0))
      {
  ...
  protected int getTableResource(int index) { return -1; }
  ...
  {
    return ICUResourceBundleReader.RES_GET_TYPE(resource) == 3;
  }

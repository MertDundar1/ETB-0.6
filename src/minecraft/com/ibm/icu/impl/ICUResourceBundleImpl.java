  ...
  extends ICUResourceBundle
{
  ...
  protected final ICUResourceBundle createBundleObject(String _key, int _resource, HashMap<String, String> table, UResourceBundle requested, boolean[] isAlias)
  {
    ...
    case 0: 
    case 6: 
      return new ResourceString(reader, _key, _resPath, _resource, this);
    case 1: 
      return new ResourceBinary(reader, _key, _resPath, _resource, this);
    case 3: 
      if (isAlias != null) {
        isAlias[0] = true;
      }
    ...
    case 7: 
      return new ResourceInt(reader, _key, _resPath, _resource, this);
    case 14: 
      return new ResourceIntVector(reader, _key, _resPath, _resource, this);
    case 8: 
    case 9: 
      return new ResourceArray(reader, _key, _resPath, _resource, this);
    case 2: 
    case 4: 
    case 5: 
      return new ResourceTable(reader, _key, _resPath, _resource, this);
    }
  ...
  private static final class ResourceInt extends ICUResourceBundleImpl {
    ...
    ResourceInt(ICUResourceBundleReader reader, String key, String resPath, int resource, ICUResourceBundleImpl container) { super(key, resPath, resource, container); }
  }
  ...
  private static final class ResourceIntVector extends ICUResourceBundleImpl { private int[] value;
    ...
    public int[] getIntVector() { return value; }
  ...
  private static class ResourceContainer extends ICUResourceBundleImpl
  {
    ...
    protected int getContainerResource(int index) { return value.getContainerResource(index); }
    ...
    ResourceContainer(ICUResourceBundleReader reader, String key, String resPath, int resource, ICUResourceBundleImpl container) { super(key, resPath, resource, container); }
  }
  ...
  private static class ResourceArray extends ICUResourceBundleImpl.ResourceContainer {
    ...
    public String[] getStringArray() { return handleGetStringArray(); }
  ...
  static class ResourceTable extends ICUResourceBundleImpl.ResourceContainer {
    protected String getKey(int index) { return ((ICUResourceBundleReader.Table)value).getKey(index); }
    ...
    protected int getTableResource(String resKey) { return ((ICUResourceBundleReader.Table)value).getTableResource(resKey); }

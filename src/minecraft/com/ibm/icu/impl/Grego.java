...
public class Grego
{
  ...
  {
    int y = year - 1;
    long julian = 365 * y + floorDivide(y, 4L) + 1721423L + floorDivide(y, 400L) - floorDivide(y, 100L) + 2L + DAYS_BEFORE[(month + 0)] + dom;
  ...
  public static int[] dayToFields(long day, int[] fields) {
    ...
    int dayOfMonth = dayOfYear - DAYS_BEFORE[month] + 1;

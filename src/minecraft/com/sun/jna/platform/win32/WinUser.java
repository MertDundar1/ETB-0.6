  ...
  extends StdCallLibrary, WinDef
{
  ...
  public static abstract interface WNDENUMPROC extends StdCallLibrary.StdCallCallback { public abstract boolean callback(WinDef.HWND paramHWND, Pointer paramPointer);
  }
  
  public static abstract interface LowLevelKeyboardProc extends WinUser.HOOKPROC { public abstract WinDef.LRESULT callback(int paramInt, WinDef.WPARAM paramWPARAM, WinUser.KBDLLHOOKSTRUCT paramKBDLLHOOKSTRUCT);
  }
  
  public static class SIZE extends Structure { public int cx;
    public int cy;

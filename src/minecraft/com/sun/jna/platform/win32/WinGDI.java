...
public abstract interface WinGDI extends com.sun.jna.win32.StdCallLibrary {
  ...
  public static class RGNDATA extends Structure { public WinGDI.RGNDATAHEADER rdh;
    ...
    public RGNDATA(int bufferSize) { Buffer = new byte[bufferSize];
      allocateMemory();
    }
  }
  ...
  public static class BITMAPINFO extends Structure { public WinGDI.BITMAPINFOHEADER bmiHeader = new WinGDI.BITMAPINFOHEADER();

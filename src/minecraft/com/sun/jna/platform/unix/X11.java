  ...
  extends com.sun.jna.Library
{
  ...
  public abstract int XAllocNamedColor(Display paramDisplay, int paramInt, String paramString, com.sun.jna.Pointer paramPointer1, com.sun.jna.Pointer paramPointer2);
    ...
    extends NativeLong
  {
    ...
    public VisualID(long value) { super(); }
    
    private static final long serialVersionUID = 1L; }
  
  public static class XID extends NativeLong { private static final long serialVersionUID = 1L;
    public static final XID None = null;
    public XID() { this(0L); }
    public XID(long id) { super(); }
    
    protected boolean isNone(Object o) { return (o == null) || (((o instanceof Number)) && (((Number)o).longValue() == 0L)); }
    ...
    public String toString() { return "0x" + Long.toHexString(longValue()); } }
  ...
  public static class AtomByReference extends com.sun.jna.ptr.ByReference { public AtomByReference() { super(); }
    
    public X11.Atom getValue() { NativeLong value = getPointer().getNativeLong(0L);
  ...
  public static class Colormap extends X11.XID { private static final long serialVersionUID = 1L;
    ...
    public Colormap(long id) { super(); }
    
    public Object fromNative(Object nativeValue, com.sun.jna.FromNativeContext context) { if (isNone(nativeValue))
        return None;
  ...
  public static class WindowByReference extends com.sun.jna.ptr.ByReference { public WindowByReference() { super(); }
    
    public X11.Window getValue() { NativeLong value = getPointer().getNativeLong(0L);
  ...
  public static class Display extends com.sun.jna.PointerType { public Display() {} }
  
  public static class Visual extends com.sun.jna.PointerType { public Visual() {}
    
    public NativeLong getVisualID() { if (getPointer() != null)
        return getPointer().getNativeLong(com.sun.jna.Native.POINTER_SIZE);
      return new NativeLong(0L);
    }
    
    public String toString() { return "Visual: VisualID=0x" + Long.toHexString(getVisualID().longValue()); }
  }
  
  public static class Screen extends com.sun.jna.PointerType { public Screen() {}
  }
  
  public static class GC extends com.sun.jna.PointerType { public GC() {} }
  
  public static class XImage extends com.sun.jna.PointerType { public XImage() {} }
  
  public static abstract interface Xext extends com.sun.jna.Library { public abstract void XShapeCombineMask(X11.Display paramDisplay, X11.Window paramWindow, int paramInt1, int paramInt2, int paramInt3, X11.Pixmap paramPixmap, int paramInt4);
    
    public static final Xext INSTANCE = (Xext)com.sun.jna.Native.loadLibrary("Xext", Xext.class);
  ...
  public static abstract interface Xrender extends com.sun.jna.Library { public static class XRenderPictFormat extends com.sun.jna.Structure { public X11.Xrender.PictFormat id;
      public int type;
      public int depth;
      public X11.Xrender.XRenderDirectFormat direct;
      public X11.Colormap colormap;
      public XRenderPictFormat() {} }
    public static final Xrender INSTANCE = (Xrender)com.sun.jna.Native.loadLibrary("Xrender", Xrender.class);
      ...
      extends NativeLong
    {
      ...
      public PictFormat(long value) { super(); }
    ...
    public static class XRenderDirectFormat extends com.sun.jna.Structure { public short red;
  ...
  public static abstract interface Xevie extends com.sun.jna.Library { public static final Xevie INSTANCE = (Xevie)com.sun.jna.Native.loadLibrary("Xevie", Xevie.class);
    public static final int XEVIE_UNMODIFIED = 0;
    public static final int XEVIE_MODIFIED = 1;
    
    public abstract boolean XevieQueryVersion(X11.Display paramDisplay, com.sun.jna.ptr.IntByReference paramIntByReference1, com.sun.jna.ptr.IntByReference paramIntByReference2);
  ...
  public static abstract interface XTest extends com.sun.jna.Library
  {
    public static final XTest INSTANCE = (XTest)com.sun.jna.Native.loadLibrary("Xtst", XTest.class);
    
    public abstract boolean XTestQueryExtension(X11.Display paramDisplay, com.sun.jna.ptr.IntByReference paramIntByReference1, com.sun.jna.ptr.IntByReference paramIntByReference2, com.sun.jna.ptr.IntByReference paramIntByReference3, com.sun.jna.ptr.IntByReference paramIntByReference4);
    ...
    public abstract int XTestFakeDeviceKeyEvent(X11.Display paramDisplay, X11.XDeviceByReference paramXDeviceByReference, int paramInt1, boolean paramBoolean, com.sun.jna.ptr.IntByReference paramIntByReference, int paramInt2, NativeLong paramNativeLong);
    
    public abstract int XTestFakeDeviceButtonEvent(X11.Display paramDisplay, X11.XDeviceByReference paramXDeviceByReference, int paramInt1, boolean paramBoolean, com.sun.jna.ptr.IntByReference paramIntByReference, int paramInt2, NativeLong paramNativeLong);
    
    public abstract int XTestFakeProximityEvent(X11.Display paramDisplay, X11.XDeviceByReference paramXDeviceByReference, boolean paramBoolean, com.sun.jna.ptr.IntByReference paramIntByReference, int paramInt, NativeLong paramNativeLong);
    
    public abstract int XTestFakeDeviceMotionEvent(X11.Display paramDisplay, X11.XDeviceByReference paramXDeviceByReference, boolean paramBoolean, int paramInt1, com.sun.jna.ptr.IntByReference paramIntByReference, int paramInt2, NativeLong paramNativeLong);
  ...
  public static final X11 INSTANCE = (X11)com.sun.jna.Native.loadLibrary("X11", X11.class);
  ...
  public static class XRectangle extends com.sun.jna.Structure { public short x;
    public short y;
  ...
  public abstract void XSetWMProperties(Display paramDisplay, Window paramWindow, String paramString1, String paramString2, String[] paramArrayOfString, int paramInt, XSizeHints paramXSizeHints, com.sun.jna.Pointer paramPointer1, com.sun.jna.Pointer paramPointer2);
  

  public abstract int XFree(com.sun.jna.Pointer paramPointer);
  ...
  public abstract Pixmap XCreateBitmapFromData(Display paramDisplay, Window paramWindow, com.sun.jna.Pointer paramPointer, int paramInt1, int paramInt2);
  ...
  public abstract int XQueryTree(Display paramDisplay, Window paramWindow, WindowByReference paramWindowByReference1, WindowByReference paramWindowByReference2, com.sun.jna.ptr.PointerByReference paramPointerByReference, com.sun.jna.ptr.IntByReference paramIntByReference);
  

  public abstract boolean XQueryPointer(Display paramDisplay, Window paramWindow, WindowByReference paramWindowByReference1, WindowByReference paramWindowByReference2, com.sun.jna.ptr.IntByReference paramIntByReference1, com.sun.jna.ptr.IntByReference paramIntByReference2, com.sun.jna.ptr.IntByReference paramIntByReference3, com.sun.jna.ptr.IntByReference paramIntByReference4, com.sun.jna.ptr.IntByReference paramIntByReference5);
  ...
  public abstract int XGetGeometry(Display paramDisplay, Drawable paramDrawable, WindowByReference paramWindowByReference, com.sun.jna.ptr.IntByReference paramIntByReference1, com.sun.jna.ptr.IntByReference paramIntByReference2, com.sun.jna.ptr.IntByReference paramIntByReference3, com.sun.jna.ptr.IntByReference paramIntByReference4, com.sun.jna.ptr.IntByReference paramIntByReference5, com.sun.jna.ptr.IntByReference paramIntByReference6);
  ...
  public static class XAnyEvent extends com.sun.jna.Structure { public int type;
  ...
  public static class XKeyEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XButtonEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XButtonPressedEvent extends X11.XButtonEvent { public XButtonPressedEvent() {} }
  
  public static class XButtonReleasedEvent extends X11.XButtonEvent { public XButtonReleasedEvent() {} }
  
  public static class XClientMessageEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
    public X11.Atom message_type;
    public int format; public Data data;
    public static class Data extends com.sun.jna.Union { public Data() {}
  ...
  public static class XMotionEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XPointerMovedEvent extends X11.XMotionEvent { public XPointerMovedEvent() {} }
  
  public static class XCrossingEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XEnterWindowEvent extends X11.XCrossingEvent { public XEnterWindowEvent() {} }
  
  public static class XLeaveWindowEvent extends X11.XCrossingEvent { public XLeaveWindowEvent() {} }
  
  public static class XFocusChangeEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XFocusInEvent extends X11.XFocusChangeEvent { public XFocusInEvent() {} }
  
  public static class XFocusOutEvent extends X11.XFocusChangeEvent { public XFocusOutEvent() {} }
  
  public static class XExposeEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XGraphicsExposeEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
  ...
  public static class XNoExposeEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Drawable drawable;
  ...
  public static class XVisibilityEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XCreateWindowEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
  ...
  public static class XDestroyWindowEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
  ...
  public static class XUnmapEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window event;
  ...
  public static class XMapEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window event;
  ...
  public static class XMapRequestEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window parent;
  ...
  public static class XReparentEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window event;
  ...
  public static class XConfigureEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window event;
  ...
  public static class XGravityEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window event;
  ...
  public static class XResizeRequestEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XConfigureRequestEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window parent;
  ...
  public static class XCirculateEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window event;
  ...
  public static class XCirculateRequestEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window parent;
  ...
  public static class XPropertyEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XSelectionClearEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XSelectionRequestEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
  ...
  public static class XSelectionEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window requestor;
  ...
  public static class XColormapEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XMappingEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event;
    public X11.Display display;
    public X11.Window window;
  ...
  public static class XErrorEvent extends com.sun.jna.Structure { public int type;
    public X11.Display display;
  ...
  public static class XKeymapEvent extends com.sun.jna.Structure { public int type;
    public NativeLong serial;
    public int send_event; public X11.Display display; public X11.Window window; public byte[] key_vector = new byte[32];
  ...
  public abstract boolean XTranslateCoordinates(Display paramDisplay, Window paramWindow1, Window paramWindow2, int paramInt1, int paramInt2, com.sun.jna.ptr.IntByReference paramIntByReference1, com.sun.jna.ptr.IntByReference paramIntByReference2, WindowByReference paramWindowByReference);
  ...
  public abstract XVisualInfo XGetVisualInfo(Display paramDisplay, NativeLong paramNativeLong, XVisualInfo paramXVisualInfo, com.sun.jna.ptr.IntByReference paramIntByReference);
  

  public abstract Colormap XCreateColormap(Display paramDisplay, Window paramWindow, Visual paramVisual, int paramInt);
  

  public abstract int XGetWindowProperty(Display paramDisplay, Window paramWindow, Atom paramAtom1, NativeLong paramNativeLong1, NativeLong paramNativeLong2, boolean paramBoolean, Atom paramAtom2, AtomByReference paramAtomByReference, com.sun.jna.ptr.IntByReference paramIntByReference, com.sun.jna.ptr.NativeLongByReference paramNativeLongByReference1, com.sun.jna.ptr.NativeLongByReference paramNativeLongByReference2, com.sun.jna.ptr.PointerByReference paramPointerByReference);
  

  public abstract int XChangeProperty(Display paramDisplay, Window paramWindow, Atom paramAtom1, Atom paramAtom2, int paramInt1, int paramInt2, com.sun.jna.Pointer paramPointer, int paramInt3);
  ...
  public abstract XImage XCreateImage(Display paramDisplay, Visual paramVisual, int paramInt1, int paramInt2, int paramInt3, com.sun.jna.Pointer paramPointer, int paramInt4, int paramInt5, int paramInt6, int paramInt7);
  ...
  public abstract KeySym XGetKeyboardMapping(Display paramDisplay, byte paramByte, int paramInt, com.sun.jna.ptr.IntByReference paramIntByReference);
  

  public abstract int XDisplayKeycodes(Display paramDisplay, com.sun.jna.ptr.IntByReference paramIntByReference1, com.sun.jna.ptr.IntByReference paramIntByReference2);

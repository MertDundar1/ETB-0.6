...
public class NativeLibrary
{
  ...
  static String matchLibrary(String libName, List searchPath)
  {
    ...
    FilenameFilter filter = new FilenameFilter() { private final String val$libName;
      
      public boolean accept(File dir, String filename) { return ((filename.startsWith("lib" + val$libName + ".so")) || ((filename.startsWith(val$libName + ".so")) && (val$libName.startsWith("lib")))) && (NativeLibrary.isVersionedName(filename));

...
public final class Native
{
  ...
  public static Library synchronizedLibrary(final Library library)
  {
    ...
    InvocationHandler newHandler = new InvocationHandler() { private final Library.Handler val$handler;
      
      public Object invoke(Object proxy, Method method, Object[] args) throws Throwable { synchronized (val$handler.getNativeLibrary()) {
  ...
  static File getTempDir() { File tmp = new File(System.getProperty("java.io.tmpdir"));
  ...
  public static void unregister() { unregister(getNativeClass(getCallingClass())); }
    ...
    for (int i = 0; i < handles.length; i++) {
      ...
      for (int t = 0; t < ptypes.length; t++) {
        ...
        case 21: 
          ...
          break;
        case 0: 
          long tmp890_887 = getpeer;atypes[t] = tmp890_887;closure_atypes[t] = tmp890_887;
          break;
        default: 
          long tmp932_929 = getpeer;atypes[t] = tmp932_929;closure_atypes[t] = tmp932_929;
        }
      ...
      try {
        handles[i] = registerMethod(cls, method.getName(), sig, cvt, closure_atypes, atypes, rcvt, closure_rtype, rtype, rclass, peer, f.getCallingConvention(), throwLastError, toNative, fromNative);
  ...
  public static void detach(boolean detach) { setLastError(detach ? -1 : -2); }
  ...
  private static class AWT { private AWT() {}
    
    static long getWindowID(Window w) throws HeadlessException { return getComponentID(w); }

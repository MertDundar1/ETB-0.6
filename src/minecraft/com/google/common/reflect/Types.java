...
final class Types
{
  ...
  static Type getComponentType(Type type)
  {
    ...
    new TypeVisitor() {
      ...
      void visitWildcardType(WildcardType t) { val$result.set(Types.subtypeOfComponentType(t.getUpperBounds())); }
      
      void visitGenericArrayType(GenericArrayType t) {
        val$result.set(t.getGenericComponentType());
      }
      
      void visitClass(Class<?> t) { val$result.set(t.getComponentType()); } }.visit(new Type[] { type });
    ...
    implements ParameterizedType, Serializable
  {
    ...
    public String toString() {
      ...
      builder.append(rawType.getName()).append('<').append(Types.COMMA_JOINER.join(Iterables.transform(argumentsList, Types.TYPE_TO_STRING))).append('>');

  ...
  extends ImmutableBiMap<K, V>
{
  ...
  private static final class NonTerminalBiMapEntry<K, V> extends ImmutableMapEntry<K, V> {
    ...
    NonTerminalBiMapEntry(K key, V value, @Nullable ImmutableMapEntry<K, V> nextInKeyBucket, @Nullable ImmutableMapEntry<K, V> nextInValueBucket) { super(value);
  ...
  private final class Inverse extends ImmutableBiMap<V, K> {
    ...
    final class InverseEntrySet extends ImmutableMapEntrySet<V, K> {
      ...
      ImmutableMap<V, K> map() { return RegularImmutableBiMap.Inverse.this; }
  ...
  private static class InverseSerializedForm<K, V> implements Serializable {
    ...
    InverseSerializedForm(ImmutableBiMap<K, V> forward) { this.forward = forward; }

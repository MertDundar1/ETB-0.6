...
final class Constraints
{
  ...
  static class ConstrainedCollection<E> extends ForwardingCollection<E>
  {
    ...
    protected Collection<E> delegate() { return delegate; }
    ...
    public boolean addAll(Collection<? extends E> elements) { return delegate.addAll(Constraints.checkElements(elements, constraint)); }
  }
  ...
  static class ConstrainedSet<E> extends ForwardingSet<E>
  {
    ...
    protected Set<E> delegate() { return delegate; }
  ...
  private static class ConstrainedSortedSet<E> extends ForwardingSortedSet<E>
  {
    ...
    protected SortedSet<E> delegate() { return delegate; }
    
    public SortedSet<E> headSet(E toElement) {
      return Constraints.constrainedSortedSet(delegate.headSet(toElement), constraint);
    }
    
    public SortedSet<E> subSet(E fromElement, E toElement) { return Constraints.constrainedSortedSet(delegate.subSet(fromElement, toElement), constraint); }
    


    public SortedSet<E> tailSet(E fromElement) { return Constraints.constrainedSortedSet(delegate.tailSet(fromElement), constraint); }
    ...
    extends ForwardingList<E>
  {
    ...
    public void add(int index, E element) { constraint.checkElement(element);
    ...
    public ListIterator<E> listIterator() { return Constraints.constrainedListIterator(delegate.listIterator(), constraint); }
    

    public ListIterator<E> listIterator(int index) { return Constraints.constrainedListIterator(delegate.listIterator(index), constraint); }
    ...
    public List<E> subList(int fromIndex, int toIndex) { return Constraints.constrainedList(delegate.subList(fromIndex, toIndex), constraint); }
  }
  ...
  static class ConstrainedListIterator<E> extends ForwardingListIterator<E>
  {
    ...
    protected ListIterator<E> delegate() { return delegate; }
    ...
    public void set(E element) { constraint.checkElement(element);

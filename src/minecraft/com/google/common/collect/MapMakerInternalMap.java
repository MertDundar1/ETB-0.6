  ...
  implements ConcurrentMap<K, V>, Serializable
{
    ...
    implements MapMakerInternalMap.ReferenceEntry<Object, Object>
  {
    ...
    public MapMakerInternalMap.ValueReference<Object, Object> getValueReference() { return null; }
  ...
  static abstract class AbstractReferenceEntry<K, V> implements MapMakerInternalMap.ReferenceEntry<K, V> {
  ...
  static final class StrongExpirableEntry<K, V> extends MapMakerInternalMap.StrongEntry<K, V> implements MapMakerInternalMap.ReferenceEntry<K, V>
  {
    ...
    public void setNextExpirable(MapMakerInternalMap.ReferenceEntry<K, V> next) { nextExpirable = next; }
  ...
  static final class StrongEvictableEntry<K, V> extends MapMakerInternalMap.StrongEntry<K, V> implements MapMakerInternalMap.ReferenceEntry<K, V>
  {
    ...
    public void setNextEvictable(MapMakerInternalMap.ReferenceEntry<K, V> next) { nextEvictable = next; }
    ...
    extends ReentrantLock
  {
    ...
    boolean containsKey(Object key, int hash) {
      try { MapMakerInternalMap.ReferenceEntry<K, V> e;
        if (count != 0) {
      ...
      try {
        ...
        for (MapMakerInternalMap.ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
          ...
          if ((e.getHash() == hash) && (entryKey != null) && (map.keyEquivalence.equivalent(key, entryKey)))
          {
            ...
            if (entryValue != null) {
              cause = MapMaker.RemovalCause.EXPLICIT; } else { MapMaker.RemovalCause cause;
              if (isCollected(valueReference)) {
      ...
      try {
        ...
        for (MapMakerInternalMap.ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
          ...
          if ((e.getHash() == hash) && (entryKey != null) && (map.keyEquivalence.equivalent(key, entryKey)))
          {
            ...
            MapMakerInternalMap.ReferenceEntry<K, V> newFirst; if (v == valueReference) {
              modCount += 1;
    ...
    extends AbstractQueue<MapMakerInternalMap.ReferenceEntry<K, V>>
  {
    final MapMakerInternalMap.ReferenceEntry<K, V> head = new MapMakerInternalMap.AbstractReferenceEntry()
    {
      ...
      public MapMakerInternalMap.ReferenceEntry<K, V> getNextExpirable() { return nextExpirable; }
    ...
    implements Iterator<E>
  {
    ...
    boolean nextInTable()
    {
      while (nextTableIndex >= 0) {
        if (((this.nextEntry = (MapMakerInternalMap.ReferenceEntry)currentTable.get(nextTableIndex--)) != null) && (
  ...
  final class KeyIterator extends MapMakerInternalMap<K, V>.HashIterator<K> { KeyIterator() { super(); }
  ...
  final class EntryIterator extends MapMakerInternalMap<K, V>.HashIterator<Map.Entry<K, V>> { EntryIterator() { super(); }

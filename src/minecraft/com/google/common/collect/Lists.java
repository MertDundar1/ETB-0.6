...
public final class Lists
{
  ...
  @VisibleForTesting
  static int computeArrayListCapacity(int arraySize) { CollectPreconditions.checkNonnegative(arraySize, "arraySize");
  ...
  private static class OnePlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess
  {
    ...
    public int size() { return rest.length + 1; }
  ...
  static <E> List<E> subListImpl(List<E> list, int fromIndex, int toIndex)
  {
    ...
    List<E> wrapper;
    if ((list instanceof RandomAccess)) {
      wrapper = new RandomAccessListWrapper(list) { private static final long serialVersionUID = 0L;
        
        public ListIterator<E> listIterator(int index) { return backingList.listIterator(index);
        }

      };
    }
    else {
      wrapper = new AbstractListWrapper(list) { private static final long serialVersionUID = 0L;

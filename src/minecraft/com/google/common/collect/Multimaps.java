...
public final class Multimaps
{
  ...
  private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
    ...
    public Map<K, Collection<V>> asMap() {
      ...
      if (result == null) {
        result = this.map = Collections.unmodifiableMap(Maps.transformValues(delegate.asMap(), new Function()
        {
  ...
  private static class UnmodifiableListMultimap<K, V> extends Multimaps.UnmodifiableMultimap<K, V> implements ListMultimap<K, V>
  {
    ...
    public ListMultimap<K, V> delegate() { return (ListMultimap)super.delegate(); }
  ...
  private static class UnmodifiableSetMultimap<K, V> extends Multimaps.UnmodifiableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public SetMultimap<K, V> delegate() { return (SetMultimap)super.delegate(); }
    ...
    public Set<Map.Entry<K, V>> entries() { return Maps.unmodifiableEntrySet(delegate().entries()); }
  ...
  private static class UnmodifiableSortedSetMultimap<K, V> extends Multimaps.UnmodifiableSetMultimap<K, V> implements SortedSetMultimap<K, V> {
    ...
    public SortedSetMultimap<K, V> delegate() { return (SortedSetMultimap)super.delegate(); }
  ...
  static class Keys<K, V> extends AbstractMultiset<K> {
    ...
    Set<Multiset.Entry<K>> createEntrySet() { return new KeysEntrySet(); }
    
    class KeysEntrySet extends Multisets.EntrySet<K> {
      KeysEntrySet() {}
      
      Multiset<K> multiset() { return Multimaps.Keys.this; }
    ...
    extends Maps.ImprovedAbstractMap<K, Collection<V>>
  {
    ...
    class EntrySet extends Maps.EntrySet<K, Collection<V>> {
      ...
      Map<K, Collection<V>> map() { return Multimaps.AsMap.this; }

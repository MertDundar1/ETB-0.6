  ...
  implements Serializable
{
  ...
  {
    ConcurrentHashMultiset<E>.EntrySet result = entrySet;
    if (result == null) {
      entrySet = (result = new EntrySet(null));
    }
    return result;
  }
  ...
  public void clear() { countMap.clear(); }
  
  private class EntrySet extends AbstractMultiset<E>.EntrySet {
    private EntrySet() { super(); }
    
    ConcurrentHashMultiset<E> multiset() { return ConcurrentHashMultiset.this; }

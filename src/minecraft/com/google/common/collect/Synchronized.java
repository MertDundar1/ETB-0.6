...
final class Synchronized
{
  ...
  private static class SynchronizedListMultimap<K, V> extends Synchronized.SynchronizedMultimap<K, V> implements ListMultimap<K, V> {
    ...
    ListMultimap<K, V> delegate() { return (ListMultimap)super.delegate(); }
    ...
    public List<V> removeAll(Object key) { synchronized (mutex) {
        return delegate().removeAll(key);
      }
    }
  ...
  private static class SynchronizedSetMultimap<K, V> extends Synchronized.SynchronizedMultimap<K, V> implements SetMultimap<K, V>
  {
    ...
    SetMultimap<K, V> delegate() { return (SetMultimap)super.delegate(); }
    ...
    public Set<V> removeAll(Object key) { synchronized (mutex) {
        return delegate().removeAll(key);
      }
    }
    ...
    public Set<Map.Entry<K, V>> entries() { synchronized (mutex) {
        if (entrySet == null) {
  ...
  private static class SynchronizedSortedSetMultimap<K, V> extends Synchronized.SynchronizedSetMultimap<K, V> implements SortedSetMultimap<K, V> {
    ...
    SortedSetMultimap<K, V> delegate() { return (SortedSetMultimap)super.delegate(); }
    ...
    public SortedSet<V> removeAll(Object key) { synchronized (mutex) {
        return delegate().removeAll(key);
      }
    }
  ...
  private static class SynchronizedAsMapEntries<K, V> extends Synchronized.SynchronizedSet<Map.Entry<K, Collection<V>>>
  {
      ...
      new ForwardingIterator() {
        ...
        public Map.Entry<K, Collection<V>> next() {
          ...
          new ForwardingMapEntry() {
            ...
            public Collection<V> getValue() { return Synchronized.typePreservingCollection((Collection)entry.getValue(), mutex); }
          };
        }
      };
    }
    ...
    public <T> T[] toArray(T[] array) { synchronized (mutex) {
    ...
    public boolean containsAll(Collection<?> c) { synchronized (mutex) {
    ...
    public boolean removeAll(Collection<?> c) { synchronized (mutex) {
        return Iterators.removeAll(delegate().iterator(), c);
      }
    }
    
    public boolean retainAll(Collection<?> c) { synchronized (mutex) {
  ...
  private static class SynchronizedAsMapValues<V> extends Synchronized.SynchronizedCollection<Collection<V>>
  {
    ...
    public Iterator<Collection<V>> iterator()
    {
      ...
      new ForwardingIterator() {
        ...
        public Collection<V> next() { return Synchronized.typePreservingCollection((Collection)super.next(), mutex); }
      };
    }
  }

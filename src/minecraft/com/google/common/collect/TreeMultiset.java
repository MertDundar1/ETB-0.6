  ...
  implements Serializable
{
  ...
  @Nullable
  private AvlNode<E> lastNode() { AvlNode<E> root = (AvlNode)rootReference.get();
    if (root == null) {
      return null;
    }
    AvlNode<E> node;
  ...
  private static final class Reference<T> {
    ...
    @Nullable
    private T value;
    public void checkAndSet(@Nullable T expected, T newValue) { if (value != expected) {
  ...
  private static final class AvlNode<E> extends Multisets.AbstractEntry<E>
  {
    ...
    private static int height(@Nullable AvlNode<?> node) { return node == null ? 0 : height; }
    
    @Nullable
    private AvlNode<E> ceiling(Comparator<? super E> comparator, E e) {
      int cmp = comparator.compare(e, elem);
      if (cmp < 0)
        return left == null ? this : (AvlNode)Objects.firstNonNull(left.ceiling(comparator, e), this);
      if (cmp == 0) {
        return this;
      }
    ...
    private AvlNode<E> floor(Comparator<? super E> comparator, E e) {
      int cmp = comparator.compare(e, elem);
      if (cmp > 0)
        return right == null ? this : (AvlNode)Objects.firstNonNull(right.floor(comparator, e), this);
      if (cmp == 0) {
        return this;
      }

...
public final class Multisets
{
  ...
  static class UnmodifiableMultiset<E> extends ForwardingMultiset<E> implements Serializable {
    ...
    UnmodifiableMultiset(Multiset<? extends E> delegate) { this.delegate = delegate; }
    ...
    public Set<Multiset.Entry<E>> entrySet()
    {
      ...
      return es == null ? (this.entrySet = Collections.unmodifiableSet(delegate.entrySet())) : es;
    }
  ...
  public static <E> Multiset.Entry<E> immutableEntry(@Nullable E e, int n) { return new ImmutableEntry(e, n); }
  ...
  static abstract class ElementSet<E> extends Sets.ImprovedAbstractSet<E> {
    ...
    public void clear() { multiset().clear(); }
    ...
    public int size() { return multiset().entrySet().size(); }
  }
  ...
  static abstract class EntrySet<E> extends Sets.ImprovedAbstractSet<Multiset.Entry<E>> {
    ...
    public boolean contains(@Nullable Object o) { if ((o instanceof Multiset.Entry))
      {
    ...
    implements Iterator<E>
  {
    ...
    public E next()
    {
      ...
      if (laterCount == 0) {
        ...
        totalCount = (this.laterCount = currentEntry.getCount());
      }
      laterCount -= 1;
      canRemove = true;

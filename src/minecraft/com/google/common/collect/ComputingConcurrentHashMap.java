  ...
  extends MapMakerInternalMap<K, V>
{
  ...
  {
    ComputingSegment(MapMakerInternalMap<K, V> map, int initialCapacity, int maxSegmentSize) { super(initialCapacity, maxSegmentSize); }
      ...
      try {
        ...
        do {
          ...
          if ((e == null) || (!e.getValueReference().isComputingReference())) {
            ...
            if (createNewEntry)
            {
              return compute(key, hash, e, (ComputingConcurrentHashMap.ComputingValueReference)computingValueReference);
            }
          }

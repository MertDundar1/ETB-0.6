  ...
  implements RangeMap<K, V>
{
  ...
  private class SubRangeMap implements RangeMap<K, V>
  {
    ...
    public Range<K> span()
    {
      ...
      Cut<K> lowerBound;
      Cut<K> lowerBound; if ((lowerEntry != null) && (((TreeRangeMap.RangeMapEntry)lowerEntry.getValue()).getUpperBound().compareTo(subRange.lowerBound) > 0))
      {
      ...
      if (upperEntry == null)
        throw new NoSuchElementException();
      Cut<K> upperBound; Cut<K> upperBound; if (((TreeRangeMap.RangeMapEntry)upperEntry.getValue()).getUpperBound().compareTo(subRange.upperBound) >= 0) {
      ...
      public Set<Map.Entry<Range<K>, V>> entrySet()
      {
        new Maps.EntrySet()
        {
          ...
          public Iterator<Map.Entry<Range<K>, V>> iterator()
          {
            ...
            Cut<K> cutToStart = (Cut)Objects.firstNonNull(entriesByLowerBound.floorKey(subRange.lowerBound), subRange.lowerBound);

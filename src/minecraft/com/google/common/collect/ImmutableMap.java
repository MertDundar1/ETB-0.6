  ...
  implements Map<K, V>, Serializable
{
    ...
    implements Serializable
  {
    ...
    Object readResolve() { ImmutableMap.Builder<Object, Object> builder = new ImmutableMap.Builder();
      return createMap(builder);
    }
    
    Object createMap(ImmutableMap.Builder<Object, Object> builder) { for (int i = 0; i < keys.length; i++) {

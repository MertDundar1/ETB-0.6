  ...
  implements Comparable<Cut<C>>, Serializable
{
    ...
    extends Cut<Comparable<?>>
  {
    ...
    BoundType typeAsUpperBound() { throw new AssertionError("this statement should be unreachable"); }
    ...
    void describeAsLowerBound(StringBuilder sb) { sb.append("(-∞"); }
  ...
  private static final class AboveAll extends Cut<Comparable<?>> {
    ...
    BoundType typeAsUpperBound() { throw new IllegalStateException(); }
    ...
    void describeAsLowerBound(StringBuilder sb) { throw new AssertionError(); }
  ...
  private static final class BelowValue<C extends Comparable> extends Cut<C> {
    ...
    BoundType typeAsLowerBound() { return BoundType.CLOSED; }
    

    BoundType typeAsUpperBound() { return BoundType.OPEN; }
    ...
    void describeAsUpperBound(StringBuilder sb) { sb.append(endpoint).append(')'); }
    
    C leastValueAbove(DiscreteDomain<C> domain) {
      return endpoint;
    }
    
    C greatestValueBelow(DiscreteDomain<C> domain) { return domain.previous(endpoint); }
  ...
  private static final class AboveValue<C extends Comparable> extends Cut<C> {
    ...
    BoundType typeAsLowerBound() { return BoundType.OPEN; }
    

    BoundType typeAsUpperBound() { return BoundType.CLOSED; }
    ...
    C greatestValueBelow(DiscreteDomain<C> domain) { return endpoint; }
    ...
    public int hashCode() { return endpoint.hashCode() ^ 0xFFFFFFFF; }

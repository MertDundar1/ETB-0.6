...
public final class Maps
{
  ...
  static <K, V> UnmodifiableIterator<V> valueIterator(UnmodifiableIterator<Map.Entry<K, V>> entryIterator)
  {
    new UnmodifiableIterator()
    {
      ...
      public V next()
      {
        return ((Map.Entry)val$entryIterator.next()).getValue();
      }
    };
  }
  ...
  static class SortedMapDifferenceImpl<K, V>
    extends Maps.MapDifferenceImpl<K, V> implements SortedMapDifference<K, V>
  {
  ...
  static class UnmodifiableEntrySet<K, V> extends Maps.UnmodifiableEntries<K, V> implements Set<Map.Entry<K, V>>
  {
  ...
  private static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
    ...
    BiMapConverter(BiMap<A, B> bimap) { this.bimap = ((BiMap)Preconditions.checkNotNull(bimap)); }
  ...
  private static class UnmodifiableBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable
  {
    ...
    public BiMap<V, K> inverse()
    {
      ...
      return result == null ? (this.inverse = new UnmodifiableBiMap(delegate.inverse(), this)) : result;
    }
    ...
    {
      Set<V> result = values;
      return result == null ? (this.values = Collections.unmodifiableSet(delegate.values())) : result;
    }
  }
  ...
  static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(Function<? super V1, V2> function)
  {
    ...
    new EntryTransformer()
    {
      public V2 transformEntry(K key, V1 value) {
        return val$function.apply(value);
      }
    };
  }
  ...
  static <K, V1, V2> Function<V1, V2> asValueToValueFunction(EntryTransformer<? super K, V1, V2> transformer, final K key)
  {
    ...
    new Function()
    {
      public V2 apply(@Nullable V1 v1) {
        return val$transformer.transformEntry(key, v1);
      }
    };
  }
  ...
  static <K, V1, V2> Function<Map.Entry<K, V1>, V2> asEntryToValueFunction(EntryTransformer<? super K, ? super V1, V2> transformer)
  {
    ...
    new Function()
    {
      public V2 apply(Map.Entry<K, V1> entry) {
        return val$transformer.transformEntry(entry.getKey(), entry.getValue());
      }
    };
  }
  ...
  static <V2, K, V1> Map.Entry<K, V2> transformEntry(final EntryTransformer<? super K, ? super V1, V2> transformer, Map.Entry<K, V1> entry)
  {
    ...
    new AbstractMapEntry()
    {
      ...
      public V2 getValue()
      {
        return transformer.transformEntry(val$entry.getKey(), val$entry.getValue());
      }
    };
  }
  ...
  static <K, V1, V2> Function<Map.Entry<K, V1>, Map.Entry<K, V2>> asEntryToEntryFunction(EntryTransformer<? super K, ? super V1, V2> transformer)
  {
    ...
    new Function()
    {
      ...
      public Map.Entry<K, V2> apply(Map.Entry<K, V1> entry) { return Maps.transformEntry(val$transformer, entry); }
    };
  }
  ...
  static class TransformedEntriesMap<K, V1, V2> extends Maps.ImprovedAbstractMap<K, V2> {
    ...
    public V2 get(Object key)
    {
      ...
      return (value != null) || (fromMap.containsKey(key)) ? transformer.transformEntry(key, value) : null;
    }
    ...
    {
      return fromMap.containsKey(key) ? transformer.transformEntry(key, fromMap.remove(key)) : null;
    }
  ...
  static class TransformedEntriesSortedMap<K, V1, V2>
    extends Maps.TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2>
  {
    ...
    implements NavigableMap<K, V2>
  {
    ...
    public Map.Entry<K, V2> floorEntry(K key) { return transformEntry(fromMap().floorEntry(key)); }
    ...
    extends Maps.AbstractFilteredMap<K, V>
  {
    ...
    protected Set<Map.Entry<K, V>> createEntrySet() { return new EntrySet(null); }
    
    private class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
      private EntrySet() {}
      
      protected Set<Map.Entry<K, V>> delegate() { return filteredEntrySet; }
    ...
    extends Maps.FilteredEntryMap<K, V> implements SortedMap<K, V>
  {
    ...
    SortedSet<K> createKeySet() { return new SortedKeySet(); }
  ...
  static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V>, Serializable {
    ...
    public NavigableMap<K, V> descendingMap()
    {
      ...
      return result == null ? (this.descendingMap = new UnmodifiableNavigableMap(delegate.descendingMap(), this)) : result;
    }
  ...
  @GwtIncompatible("NavigableMap")
  static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> { private transient Comparator<? super K> comparator;
    private transient Set<Map.Entry<K, V>> entrySet;
    ...
    protected final Map<K, V> delegate() { return forward(); }

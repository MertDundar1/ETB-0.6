  ...
  implements Runnable
{
  ...
  ListenerCallQueue(L listener, Executor executor) { this.listener = Preconditions.checkNotNull(listener);
    ...
    try {
      for (;;) {
        ...
        try
        {
          ...
          logger.log(Level.SEVERE, "Exception while executing callback: " + listener + "." + methodCall, e);
        }
      }
    }
    finally

...
public final class Futures
{
            ...
            Futures.addCallback(running, new FutureCallback()
            {
              ...
              public void onFailure(Throwable t)
              {
                if (running.isCancelled()) {
                  ...
                  setException(t); } }, MoreExecutors.sameThreadExecutor());

          }
          catch (Throwable e)
          {
            setException(e); } } }, executor);
    }
          ...
          outputFuture.addListener(new Runnable()
          {
            public void run() {
              ...
              catch (ExecutionException e)
              {
                ...
                outputFuture = null; } } }, MoreExecutors.sameThreadExecutor());
        }
  ...
  public static <T> ImmutableList<ListenableFuture<T>> inCompletionOrder(Iterable<? extends ListenableFuture<? extends T>> futures)
  {
    ...
    for (final ListenableFuture<? extends T> future : futures) {
      ...
      {
        public void run() { ((AsyncSettableFuture)val$delegates.remove()).setFuture(future); } }, executor);
  ...
  private static class CombinedFuture<V, C> extends AbstractFuture<C> {
    ...
    protected void init(Executor listenerExecutor)
    {
      addListener(new Runnable()
      {
        public void run()
        {
          ...
          combiner = null; } }, MoreExecutors.sameThreadExecutor());
      ...
      for (final ListenableFuture<? extends V> listenable : futures) {
        ...
        listenable.addListener(new Runnable()
        {
          ...
          public void run() { Futures.CombinedFuture.this.setOneValue(index, listenable); } }, listenerExecutor);
      }
    }
    ...
    private void setOneValue(int index, Future<? extends V> future)
    {
      ...
      try
      {
        ...
        Futures.FutureCombiner<V, C> localCombiner;
        setExceptionAndMaybeLog(e.getCause()); } catch (Throwable t) { int newRemaining;
        Futures.FutureCombiner<V, C> localCombiner;
        setExceptionAndMaybeLog(t); } finally { int newRemaining;
        Futures.FutureCombiner<V, C> localCombiner;

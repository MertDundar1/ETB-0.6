...
public final class Predicates
{
  ...
  private static class NotPredicate<T> implements Predicate<T>, Serializable {
    ...
    public int hashCode() { return predicate.hashCode() ^ 0xFFFFFFFF; }
    ...
    public String toString() { return "Predicates.not(" + predicate.toString() + ")"; }
  }
  ...
  private static class AndPredicate<T> implements Predicate<T>, Serializable {
    ...
    public int hashCode() { return components.hashCode() + 306654252; }
    ...
    public String toString() { return "Predicates.and(" + Predicates.COMMA_JOINER.join(components) + ")"; }
  }
  ...
  private static class OrPredicate<T> implements Predicate<T>, Serializable
  {
    ...
    public int hashCode() { return components.hashCode() + 87855567; }
    ...
    public String toString() { return "Predicates.or(" + Predicates.COMMA_JOINER.join(components) + ")"; }
  }
    ...
    implements Predicate<T>, Serializable
  {
    ...
    public String toString() { return "Predicates.equalTo(" + target + ")"; }
  }
    ...
    implements Predicate<Object>, Serializable
  {
    ...
    public String toString() { return "Predicates.instanceOf(" + clazz.getName() + ")"; }
  }
    ...
    implements Predicate<Class<?>>, Serializable
  {
    ...
    public String toString() { return "Predicates.assignableFrom(" + clazz.getName() + ")"; }
  }

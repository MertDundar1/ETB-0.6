  ...
  implements ConcurrentMap<K, V>
{
    ...
    implements LocalCache.ReferenceEntry<Object, Object>
  {
    ...
    public LocalCache.ValueReference<Object, Object> getValueReference() { return null; }
  ...
  static abstract class AbstractReferenceEntry<K, V> implements LocalCache.ReferenceEntry<K, V> {
  ...
  static final class StrongAccessEntry<K, V> extends LocalCache.StrongEntry<K, V> {
    ...
    public void setAccessTime(long time) { accessTime = time; }
    ...
    public void setNextInAccessQueue(LocalCache.ReferenceEntry<K, V> next) { nextAccess = next; }
  ...
  static final class StrongWriteEntry<K, V> extends LocalCache.StrongEntry<K, V> {
    ...
    public void setWriteTime(long time) { writeTime = time; }
    ...
    public void setNextInWriteQueue(LocalCache.ReferenceEntry<K, V> next) { nextWrite = next; }
    ...
    extends ReentrantLock
  {
      ...
      throws ExecutionException
    {
      ...
      try { LocalCache.ReferenceEntry<K, V> e;
        if (count != 0)
        {
          e = getEntry(key, hash);
          if (e != null) {
            ...
            if (((LocalCache.ValueReference)valueReference).isLoading()) {
              return waitForLoadingValue(e, key, (LocalCache.ValueReference)valueReference);
            }
          }
        }
      ...
      loadingFuture.addListener(new Runnable()
      {
        public void run()
        {
          try {
            ...
            loadingValueReference.setException(t); } } }, LocalCache.sameThreadExecutor);
      ...
      try {
        ...
        for (LocalCache.ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
          ...
          if ((e.getHash() == hash) && (entryKey != null) && (map.keyEquivalence.equivalent(key, entryKey)))
          {
            ...
            RemovalCause cause;
            if (entryValue != null) {
              cause = RemovalCause.EXPLICIT; } else { RemovalCause cause;
              if (valueReference.isActive()) {
      ...
      try {
        ...
        for (LocalCache.ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
          ...
          if ((e.getHash() == hash) && (entryKey != null) && (map.keyEquivalence.equivalent(key, entryKey)))
          {
            ...
            LocalCache.ReferenceEntry<K, V> newFirst; if (v == valueReference) {
              modCount += 1;
    ...
    extends AbstractQueue<LocalCache.ReferenceEntry<K, V>>
  {
    final LocalCache.ReferenceEntry<K, V> head = new LocalCache.AbstractReferenceEntry()
    {
      ...
      public LocalCache.ReferenceEntry<K, V> getNextInWriteQueue() { return nextWrite; }
    ...
    {
      int size = 0;
      for (LocalCache.ReferenceEntry<K, V> e = head.getNextInWriteQueue(); e != head; 
    ...
    extends AbstractQueue<LocalCache.ReferenceEntry<K, V>>
  {
    final LocalCache.ReferenceEntry<K, V> head = new LocalCache.AbstractReferenceEntry()
    {
      ...
      public LocalCache.ReferenceEntry<K, V> getNextInAccessQueue() { return nextAccess; }
    ...
    {
      int size = 0;
      for (LocalCache.ReferenceEntry<K, V> e = head.getNextInAccessQueue(); e != head; 
  ...
  ImmutableMap<K, V> getAll(Iterable<? extends K> keys) throws ExecutionException {
    ...
    try
    {
      if (!keysToLoad.isEmpty()) {
        Iterator i$;
        try { newEntries = loadAll(keysToLoad, defaultLoader);
          ...
          Map<K, V> newEntries;
          i$ = keysToLoad.iterator(); } while (i$.hasNext()) { K key = i$.next();
          misses--;
    ...
    implements Iterator<T>
  {
    ...
    boolean nextInTable()
    {
      while (nextTableIndex >= 0) {
        if (((this.nextEntry = (LocalCache.ReferenceEntry)currentTable.get(nextTableIndex--)) != null) && (
  ...
  final class KeyIterator extends LocalCache<K, V>.HashIterator<K> { KeyIterator() { super(); }
  ...
  static class LocalManualCache<K, V> implements Cache<K, V>, Serializable {
    ...
    LocalManualCache(CacheBuilder<? super K, ? super V> builder) { this(new LocalCache(builder, null)); }
    ...
    public V get(K key, final Callable<? extends V> valueLoader) throws ExecutionException
    {
      ...
      localCache.get(key, new CacheLoader()
      {

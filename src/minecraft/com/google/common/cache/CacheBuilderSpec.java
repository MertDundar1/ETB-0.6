...
public final class CacheBuilderSpec
{
  ...
  static abstract class IntegerParser implements CacheBuilderSpec.ValueParser { IntegerParser() {}
    ...
    public void parse(CacheBuilderSpec spec, String key, String value) { Preconditions.checkArgument((value != null) && (!value.isEmpty()), "value of key %s omitted", new Object[] { key });
      try {
  ...
  static class WriteDurationParser extends CacheBuilderSpec.DurationParser {
    ...
    protected void parseDuration(CacheBuilderSpec spec, long duration, TimeUnit unit) { Preconditions.checkArgument(writeExpirationTimeUnit == null, "expireAfterWrite already set");
  ...
  static class RefreshDurationParser extends CacheBuilderSpec.DurationParser {
    ...
    protected void parseDuration(CacheBuilderSpec spec, long duration, TimeUnit unit) { Preconditions.checkArgument(refreshTimeUnit == null, "refreshAfterWrite already set");

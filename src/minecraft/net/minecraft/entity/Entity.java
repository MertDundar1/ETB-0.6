...
public abstract class Entity implements ICommandSender
{
  ...
  public void moveEntity(double x, double y, double z)
  {
    ...
    else
    {
      ...
      double var15 = y;
      double var17 = z;
      boolean var19 = ((onGround) && (isSneaking())) || (Client.instance.getModuleManager().getModuleByClass(com.enjoytheban.module.modules.world.SafeWalk.class).isEnabled()) || ((Client.instance.getModuleManager().getModuleByClass(Scaffold.class).isEnabled()) && ((this instanceof EntityPlayer)));
  ...
  public final Vec3f interpolate(float ticks) {
    return getLastTickPos().add(getPos().sub(getLastTickPos()).scale(ticks));
  }
}

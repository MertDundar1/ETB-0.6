  ...
  extends ModelBase
{
  ...
  public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
  {
    ...
    bipedRightArm.rotateAngleX = 
      (MathHelper.cos(p_78087_1_ * 0.6662F + 3.1415927F) * 2.0F * p_78087_2_ * 0.5F);
    ...
    if (heldItemLeft != 0) {
      bipedLeftArm.rotateAngleX = 
        (bipedLeftArm.rotateAngleX * 0.5F - 0.31415927F * heldItemLeft);
    }
    ...
    case 1: 
      bipedRightArm.rotateAngleX = 
        (bipedRightArm.rotateAngleX * 0.5F - 0.31415927F * heldItemRight);
      break;
    ...
    if ((Client.instance.getModuleManager().getModuleByClass(Dab.class).isEnabled()) && 
      ...
      boolean pressed = Keyboard.isKeyDown(29);
      boolean pressed2 = Keyboard.isKeyDown(157);
      if (pressed) {
        bipedHead.rotateAngleX = 0.5F;
        bipedHead.rotateAngleY = 0.75F;
        bipedRightArm.rotateAngleX = 4.75F;
        bipedRightArm.rotateAngleY = -1.0F;
        bipedLeftArm.rotateAngleX = 4.5F;
        bipedLeftArm.rotateAngleY = -1.25F;
      }
    }
    ...
    if (swingProgress > -9990.0F) {
      ...
      float var10 = MathHelper.sin(swingProgress * 3.1415927F) * -(bipedHead.rotateAngleX - 0.7F) * 
        0.75F;
      bipedRightArm.rotateAngleX = 
        ((float)(bipedRightArm.rotateAngleX - (var9 * 1.2D + var10)));

...
public class GuiConnecting extends GuiScreen
{
  ...
  private void connect(final String ipo, final int porto)
  {
    ...
    new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
    {
      ...
      public void run() {
        ...
        try
        {
          ...
          networkManager = NetworkManager.provideLanClient(var1, GuiProxy.connected ? port : porto);
          networkManager.setNetHandler(new NetHandlerLoginClient(networkManager, mc, previousGuiScreen));
          networkManager.sendPacket(new net.minecraft.network.handshake.client.C00Handshake(47, ipo, porto, EnumConnectionState.LOGIN));

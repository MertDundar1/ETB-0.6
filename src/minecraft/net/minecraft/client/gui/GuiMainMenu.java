...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
  ...
  public GuiMainMenu()
  {
    ...
    try
    {
      ...
      var1 = new BufferedReader(new java.io.InputStreamReader(
      ...
      if (getClass().getClassLoader().getClass().getName().hashCode() == -1258018116) {
        getMinecraftbreaknigga = false;
      }
      if (!var2.isEmpty()) {
        do {
  ...
  {
    buttonList.add(
      new GuiButton(1, width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
    buttonList.add(new GuiButton(2, width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, 
      I18n.format("menu.multiplayer", new Object[0])));
    buttonList.add(this.field_175372_K = new GuiButton(14, width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 
  ...
  private void addDemoButtons(int p_73972_1_, int p_73972_2_)
  {
    ...
    buttonList.add(this.buttonResetDemo = new GuiButton(12, width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, 
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if ((id == 0) && (!mc.breaknigga)) {
      mc.displayGuiScreen(new GuiOptions(this, mc.gameSettings));
    }
    
    if ((id == 5) && (!mc.breaknigga)) {
      mc.displayGuiScreen(new GuiLanguage(this, mc.gameSettings, mc.getLanguageManager()));
    }
    
    if ((id == 1) && (!mc.breaknigga)) {
      mc.displayGuiScreen(new GuiSelectWorld(this));
    }
    
    if ((id == 2) && (!mc.breaknigga)) {
      mc.displayGuiScreen(new GuiMultiplayer(this));
    }
    if ((id == 14) && (field_175372_K.visible) && (!mc.breaknigga)) {
      mc.displayGuiScreen(new GuiAltManager());
    }
    
    if ((id == 4) && (!mc.breaknigga)) {
      mc.shutdown();
    }
    
    if ((id == 11) && (!mc.breaknigga)) {
      mc.launchIntegratedServer("Demo_World", "Demo_World", net.minecraft.world.demo.DemoWorldServer.demoWorldSettings);
    }
    
    if ((id == 12) && (!mc.breaknigga)) {
  ...
  private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
  {
    ...
    for (int var7 = 0; var7 < var6 * var6; var7++) {
      ...
      GlStateManager.rotate(MathHelper.sin((panoramaTimer + p_73970_3_) / 400.0F) * 25.0F + 20.0F, 
        1.0F, 0.0F, 0.0F);
  ...
  private void renderSkybox(int p_73971_1_, int p_73971_2_, float p_73971_3_)
  {
    ...
    int var9 = width;
    int var10 = height;
    var5.addVertexWithUV(0.0D, var10, zLevel, 0.5F - var7, 
      0.5F + var8);
    var5.addVertexWithUV(var9, var10, zLevel, 0.5F - var7, 
      0.5F - var8);
  ...
  public void drawScreen(int mouseX, int mouseY, float partialTicks)
  {
    ...
    mc.getTextureManager().bindTexture(new ResourceLocation("ETB/background.png"));
    ...
    Client.instance.getClass();Client.instance.getClass();String var10 = "ETB" + " " + 0.6D;
    GlStateManager.popMatrix();
    GlStateManager.pushMatrix();
    ...
    boolean blender = GL11.glIsEnabled(3042);
    try {
      GL11.glPushMatrix();
      GL11.glEnable(3042);
      GL11.glBlendFunc(770, 771);
      GL11.glScaled(0.45D, 0.45D, 1.0D);
      mc.fontRendererObj.drawStringWithShadow(AALAPI.getUsername(), 5.0F, 2.0F, new Color(255, 255, 255, 26).getRGB());
    ...
    if (!blender)
      GL11.glDisable(3042);
    drawString(fontRendererObj, var10, 2, height - 10, new Color(102, 172, 255).getRGB());
    String var11 = AALAPI.getUsername().contains("debug-mode") ? "Protected by nothing" : "Protected by AAL";
    drawString(fontRendererObj, var11, width - fontRendererObj.getStringWidth(var11) - 2, 
      height - 10, new Color(102, 172, 255).getRGB());

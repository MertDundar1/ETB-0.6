...
public abstract class RendererLivingEntity extends Render
{
  ...
  protected FloatBuffer field_177095_g = net.minecraft.client.renderer.GLAllocation.createDirectFloatBuffer(4);
  ...
  public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
  {
    ...
    } else { GlStateManager.pushMatrix();
      GlStateManager.disableCull();
      mainModel.swingProgress = getSwingProgress(p_76986_1_, p_76986_9_);
      mainModel.isRiding = p_76986_1_.isRiding();
      
      if (Reflector.ForgeEntity_shouldRiderSit.exists()) {
        mainModel.isRiding = ((p_76986_1_.isRiding()) && (ridingEntity != null) && 
          (Reflector.callBoolean(ridingEntity, Reflector.ForgeEntity_shouldRiderSit, new Object[0])));
      }
      
      mainModel.isChild = p_76986_1_.isChild();
      try
      {
        float var19 = interpolateRotation(prevRenderYawOffset, renderYawOffset, 
          p_76986_9_);
        float var11 = interpolateRotation(prevRotationYawHead, rotationYawHead, 
          p_76986_9_);
        ...
        float var201 = prevRotationPitch + 
          (rotationPitch - prevRotationPitch) * p_76986_9_;
        ...
        float var16 = prevLimbSwingAmount + 
          (limbSwingAmount - prevLimbSwingAmount) * p_76986_9_;
        ...
        if ((mode.getValue() == ESP.ESPMode.Outline) && (esp.isEnabled())) {
          GlStateManager.depthMask(true);
          if ((!(p_76986_1_ instanceof EntityPlayer)) || (!((EntityPlayer)p_76986_1_).func_175149_v())) {
            func_177093_a(p_76986_1_, var17, var16, p_76986_9_, var14, var12, var201, var15);
          }
          
          if ((p_76986_1_ instanceof EntityPlayer)) {
            if (getMinecrafttheWorld != null) {
              renderModel(p_76986_1_, var17, var16, var14, var12, var201, var15);
  ...
  public static void setupFBO(Framebuffer fbo) {
    ...
    EXTFramebufferObject.glRenderbufferStorageEXT(36161, 34041, getMinecraftdisplayWidth, 
      getMinecraftdisplayHeight);
  ...
  protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
  {
    ...
    if ((var8) || (var9)) {
      ...
      if ((chams.isEnabled()) && (mode.getValue() == Chams.ChamsMode.Textured) && 
        ...
        GL11.glColor3d(!mcthePlayer.canEntityBeSeen(p_77036_1_) ? 1.0D : 0.0D, 
          !mcthePlayer.canEntityBeSeen(p_77036_1_) ? 0.5D : 1.0D, 
          !mcthePlayer.canEntityBeSeen(p_77036_1_) ? 0.0D : 0.0D);
  ...
  {
    if ((Client.instance.getModuleManager().getModuleByClass(com.enjoytheban.module.modules.render.Nametags.class).isEnabled()) && 
      ...
      if (Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Specials_Pre_Constructor, new Object[] { p_77033_1_, this, Double.valueOf(p_77033_2_), Double.valueOf(p_77033_4_), Double.valueOf(p_77033_6_) })) {}
    } else { if (canRenderName(p_77033_1_)) {
        ...
        if (var8 < var10 * var10) {
          ...
          if (p_77033_1_.isSneaking()) {
            ...
            GlStateManager.pushMatrix();
            GlStateManager.translate((float)p_77033_2_, (float)p_77033_4_ + height + 0.5F - (
              p_77033_1_.isChild() ? height / 2.0F : 0.0F), (float)p_77033_6_);
            ...
            func_177069_a(p_77033_1_, p_77033_2_, 
              p_77033_4_ - (p_77033_1_.isChild() ? height / 2.0F : 0.0D), 
  ...
  protected boolean canRenderName(EntityLivingBase targetEntity)
  {
    ...
    return (Minecraft.isGuiEnabled()) && (targetEntity != renderManager.livingPlayer) && 
      (!targetEntity.isInvisibleToPlayer(var2)) && (riddenByEntity == null);
  }

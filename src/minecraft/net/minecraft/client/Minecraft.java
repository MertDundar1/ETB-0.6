...
public class Minecraft implements IThreadListener, IPlayerUsage
{
  ...
  public Minecraft(GameConfiguration p_i45547_1_)
  {
    ...
    breakTheGame = Client.publicMode;
  ...
  public void run()
  {
    ...
    {
      instancegetModuleManagernicetry = (!Client.publicMode);
    }
  ...
  public void runTick()
    throws IOException
  {
    int z = 3929;int y = 10122;int x = 220345;
    if (thePlayer != null) {
    ...
    if ((currentScreen == null) || (currentScreen.allowUserInput))
    {
      ...
      while (Keyboard.next())
      {
        ...
        if (Keyboard.getEventKeyState())
        {
          ...
          {
            EventBus.getInstance().call(new com.enjoytheban.api.events.misc.EventKey(var1));
            ...
            if ((gameSettings.keyBindSmoothCamera.isPressed()) || (breakTheGame))
            {
